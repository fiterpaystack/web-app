import{Ad as ht,Af as Rt,Cc as et,D as E,Dc as it,Dd as bt,Df as Pt,E as y,Ea as t,Ec as at,Fa as c,Fc as nt,G as w,Ga as h,Ha as b,J as Q,K as z,Kc as lt,Ke as vt,Le as gt,Me as _t,Mf as Tt,Nc as ot,Oa as B,Oe as St,Pb as F,Pe as Dt,Qc as rt,Ra as m,Re as It,Sa as p,Sb as O,Se as Mt,Tb as V,Tc as mt,Ue as Et,Vb as U,Ve as yt,Wc as pt,Xe as wt,Yb as L,Yc as A,Z as o,Zc as j,ad as H,ba as f,bb as W,ca as R,cd as st,da as P,fg as Bt,ga as d,gd as ct,hd as dt,ia as C,jc as Z,ld as ut,ma as i,na as a,nb as g,nd as Ct,oa as u,pa as D,qa as I,sa as J,sc as N,ta as T,ua as K,vb as X,vd as ft,xb as Y,xd as xt,yc as tt}from"./chunk-3R2LASX6.js";import"./chunk-O7S4L63H.js";var _=(()=>{class e{constructor(n){this.http=n}getFilteredClients(n,l,r,x,v){let S=new X().set("displayName",x).set("orphansOnly",r.toString()).set("sortOrder",l).set("orderBy",n);return v&&(S=S.set("officeId",v)),this.http.get("/clients",{params:S})}getClientCollateral(n,l){return this.http.get(`/clients/${n}/collaterals/${l}`)}updateClientCollateral(n,l,r){return this.http.put(`/clients/${n}/collaterals/${l}`,r)}deleteCollateral(n,l){return this.http.delete(`/clients/${n}/collaterals/${l}`)}static{this.\u0275fac=function(l){return new(l||e)(w(Y))}}static{this.\u0275prov=E({token:e,factory:e.\u0275fac,providedIn:"root"})}}return e})();var Ht=()=>["edit"];function qt(e,s){e&1&&(i(0,"button",16),t(1,`
