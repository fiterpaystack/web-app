...
`)),l&2){let g=R(57),h=R(71),T=R(76),$=R(83),wt=R(93);r(10),bt("matTooltip",c(11,28,"tooltips.Recurring Deposits Account")),d("src","assets/images/recurring-deposits_account_placeholder.png",Bn),r(15),d("ngClass",c(26,30,p.recurringDepositsAccountData.status.code))("matTooltip",p.recurringDepositsAccountData.status.value),r(2),M(`
      ...
      `),r(3),d("ngIf",p.recurringDepositsAccountData.clientId),r(2),d("ngForOf",p.savingsDatatables)}},dependencies:[I,be,Mt,F,Ge,Te,O,L,W,lt,pe,E,Qn,Kn,Yn,se,Wn,ci,Ie,Le,We,ut,ze,$e,Zn,ti,qn,ei,Vn,ai],encapsulation:2})}}return e})();function wi(e,s){e&1&&(n(0,"th",17),t(1),o(2,"translate"),i()),e&2&&(r(),u(c(2,1,"labels.inputs.Period")))}function Fi(e,s){if(e&1&&(n(0,"td",18),t(1),o(2,"translateKey"),i()),e&2){let a=s.$implicit;r(),oe(`
...
`)),l&2){let g;d("formGroup",p.recurringDepositAccountDetailsForm),r(7),u(c(8,12,"labels.inputs.Product Name")),r(5),d("ngForOf",p.productData),r(4),M(`
    ...
    `),r(3),d("disabled",!((g=p.recurringDepositAccountDetailsForm.get("productId"))!=null&&g.value)||!((g=p.recurringDepositAccountDetailsForm.get("submittedOnDate"))!=null&&g.value)),r(),x(`
      ...
      `)}},dependencies:[I,Mt,F,O,it,ct,Y,nt,st,at,rt,Z,X,mt,xt,dt,Et,Ot,_t,Ct,ft,V,E,se,Qt,ut,ne],styles:[".margin-t[_ngcontent-%COMP%]{margin-top:1em}"]})}}return e})();function Vr(e,s){if(e&1&&(n(0,"mat-option",13),t(1),o(2,"translateKey"),i()),e&2){let a=s.$implicit;d("value",a.id),r(),x(`
