import{Cd as ht,D as E,Dc as et,E as y,Ea as t,Ec as it,Fa as c,Fc as at,Fd as bt,G as w,Ga as h,Gc as nt,Gf as Rt,Ha as b,J as Q,Jf as Pt,K as z,Lc as lt,Oa as B,Oc as ot,Pb as F,Pe as vt,Qe as gt,Ra as m,Rc as rt,Re as _t,Sa as p,Sb as O,Sf as Tt,Tb as V,Te as St,Uc as mt,Ue as Dt,Vb as U,We as It,Xc as pt,Xe as Mt,Yb as L,Z as o,Zc as A,Ze as Et,_c as j,_e as yt,af as wt,ba as f,bb as W,bd as H,ca as R,da as P,dd as st,ga as d,hd as ct,ia as C,id as dt,kc as Z,lg as Bt,ma as i,md as ut,na as a,nb as g,oa as u,od as Ct,pa as D,qa as I,sa as J,ta as T,tc as N,ua as K,vb as X,xb as Y,xd as ft,zc as tt,zd as xt}from"./chunk-66H7KJ2J.js";import"./chunk-QDSGMOWV.js";var _=(()=>{class e{constructor(n){this.http=n}getFilteredClients(n,l,r,x,v){let S=new X().set("displayName",x).set("orphansOnly",r.toString()).set("sortOrder",l).set("orderBy",n);return v&&(S=S.set("officeId",v)),this.http.get("/clients",{params:S})}getClientCollateral(n,l){return this.http.get(`/clients/${n}/collaterals/${l}`)}updateClientCollateral(n,l,r){return this.http.put(`/clients/${n}/collaterals/${l}`,r)}deleteCollateral(n,l){return this.http.delete(`/clients/${n}/collaterals/${l}`)}static{this.\u0275fac=function(l){return new(l||e)(w(Y))}}static{this.\u0275prov=E({token:e,factory:e.\u0275fac,providedIn:"root"})}}return e})();var Ht=()=>["edit"];function qt(e,s){e&1&&(i(0,"button",16),t(1,`
