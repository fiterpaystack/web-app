import{a as Tn,b as Mn}from"./chunk-YOG2Q2YP.js";import{a as mi}from"./chunk-UOIURVRE.js";import{$b as Pn,$c as st,$e as Qt,Ac as E,Bb as te,Ca as bt,Cd as ft,D as It,Db as kn,Dd as _t,E as Ve,Ed as Ct,Fa as St,Fc as Q,G as yt,Ga as Pt,Gc as U,Gd as Rt,Ha as Tt,Hd as Ft,Ia as R,Id as pe,Ja as t,K as Zt,Ka as u,Kc as ct,L as S,La as x,Lb as Me,Lc as q,Ld as ut,Lf as ni,M as P,Ma as M,Mb as ye,Mc as Y,Me as Jn,Na as oe,Nc as nt,Nd as Ue,Ob as ae,Od as He,Pb as re,Qb as Ae,Qc as J,Qf as ii,Rf as Yt,S as qe,Sc as it,Sd as ce,Sf as ai,Ta as z,Tc as Ee,Te as Ke,Tf as Ze,Ua as xe,Uc as Ln,Ud as $e,Ue as Xn,Uf as ri,Vb as k,Vc as at,Wa as o,Wb as Vn,We as Qe,Xa as c,Xe as Ye,Ya as w,Yb as H,Yc as rt,Yd as fe,Ye as Je,Z as Bn,Zb as L,Zd as se,Ze as Xe,Zf as le,_a as G,_b as qn,_e as ne,af as Bt,ba as r,bc as Ie,bf as Nt,cc as V,cd as ot,cf as kt,cg as oi,de as ze,dg as tn,eb as Nn,ed as O,ee as Le,ef as Vt,eg as Re,fa as C,fb as be,fd as W,fe as We,ff as qt,ga as A,gb as Mt,gd as Wn,ha as je,hb as F,hd as Kn,hf as jt,hg as pi,ib as Se,id as lt,if as Gt,ka as m,kd as gt,kf as Ut,ld as Qn,lf as Ht,ma as ve,md as Yn,mg as ci,na as d,nd as X,nf as $t,ob as Pe,od as mt,og as si,pc as jn,qc as Gn,qf as _e,ra as n,rb as Ge,rc as ee,rd as xt,sa as i,sb as Te,sc as Un,sd as Z,ta as f,tb as I,tc as Hn,ua as D,uc as $n,ud as Kt,va as v,vc as zn,vd as dt,vf as Zn,vg as we,wf as ti,wg as li,xa as y,xd as Ot,xf as ei,ya as b,za as _,zc as Oe,zd as Et}from"./chunk-LP5X7GDJ.js";import{a as B,b as K}from"./chunk-SVF2KWCI.js";var N=(()=>{class e{constructor(a){this.http=a}getRecurringDepositsAccountData(a){let l=new te().set("associations","all");return this.http.get(`/recurringdepositaccounts/${a}`,{params:l})}getStandingInstructions(a,l,p,g,h){let T=new te().set("clientId",a).set("clientName",l).set("fromAccountId",p).set("fromAccountType","2").set("locale",g).set("dateFormat",h);return this.http.get("/standinginstructions",{params:T})}getRecurringDepositsAccountTemplate(a,l){let p=new te().set("clientId",a);return p=l?p.set("productId",l):p,this.http.get("/recurringdepositaccounts/template",{params:p})}createRecurringDepositAccount(a){return this.http.post("/recurringdepositaccounts",a)}executeRecurringDepositsAccountCommand(a,l,p){let g=new te().set("command",l);return l==="deposit"||l==="withdrawal"?this.http.post(`/recurringdepositaccounts/${a}/transactions`,p,{params:g}):this.http.post(`/recurringdepositaccounts/${a}`,p,{params:g})}deleteRecurringDepositsAccount(a){return this.http.delete(`/recurringdepositaccounts/${a}`)}getRecurringDepositsAccountAndTemplate(a){let l=new te().set("associations","charges").set("template","true");return this.http.get(`/recurringdepositaccounts/${a}`,{params:l})}updateRecurringDepositAccount(a,l){return this.http.put(`/recurringdepositaccounts/${a}`,l)}getRecurringDepositAccountActionResource(a,l){let p=new te().set("command",l);return this.http.get(`/recurringdepositaccounts/${a}/template`,{params:p})}getRecurringDepositAccountTransactionTemplateResource(a,l){let p=new te().set("command",l);return this.http.get(`/recurringdepositaccounts/${a}/transactions/template`,{params:p})}getRecurringDepositsAccountTransaction(a,l){return this.http.get(`/recurringdepositaccounts/${a}/transactions/${l}`)}getRecurringDepositsAccountTransactionTemplate(a,l){let p=new te().set("template","true");return this.http.get(`/recurringdepositaccounts/${a}/transactions/${l}`,{params:p})}executeRecurringDepositsAccountTransactionsCommand(a,l,p,g){let h=new te().set("command",l);return this.http.post(`/recurringdepositaccounts/${a}/transactions/${g}`,p,{params:h})}static{this.\u0275fac=function(l){return new(l||e)(yt(kn))}}static{this.\u0275prov=It({token:e,factory:e.\u0275fac,providedIn:"root"})}}return e})();var en=class{constructor(s){this.setOptions(s),this.setButtons(s)}get singleButtons(){return this.buttonsArray}get options(){return this.optionArray}setButtons(s){switch(s){case"Active":this.buttonsArray=[{name:"Deposit",icon:"fa fa-arrow-up",taskPermissionName:"DEPOSIT_RECURRINGDEPOSITACCOUNT"},{name:"Withdrawal",icon:"fa fa-arrow-down",taskPermissionName:"WITHDRAWAL_RECURRINGDEPOSITACCOUNT"},{name:"Premature Close",icon:"fa fa-arrow-left",taskPermissionName:"PREMATURECLOSE_RECURRINGDEPOSITACCOUNT"},{name:"Calculate Interest",icon:"fa fa-calculator",taskPermissionName:"CALCULATEINTEREST_RECURRINGDEPOSITACCOUNT"},{name:"Undo Activation",icon:"fa fa-undo",taskPermissionName:"UNDO_ACTIVATE_RECURRINGDEPOSITACCOUNT"}];break;case"Submitted and pending approval":this.buttonsArray=[{name:"Modify Application",icon:"fa fa-edit",taskPermissionName:"UPDATE_RECURRINGDEPOSITACCOUNT"},{name:"Approve",icon:"fa fa-check",taskPermissionName:"APPROVE_RECURRINGDEPOSITACCOUNT"}];break;case"Approved":this.buttonsArray=[{name:"Undo Approval",icon:"fa fa-undo",taskPermissionName:"APPROVALUNDO_RECURRINGDEPOSITACCOUNT"},{name:"Activate",icon:"fa fa-check",taskPermissionName:"ACTIVATE_RECURRINGDEPOSITACCOUNT"}];break;case"Matured":this.buttonsArray=[{name:"Close",icon:"fa fa-arrow-right",taskPermissionName:"CLOSE_RECURRINGDEPOSITACCOUNT"},{name:"Calculate Interest",icon:"fa fa-calculator",taskPermissionName:"CALCULATEINTEREST_RECURRINGDEPOSITACCOUNT"},{name:"Post Interest",icon:"fa fa-money",taskPermissionName:"POSTINTEREST_RECURRINGDEPOSITACCOUNT"}];break;default:this.buttonsArray=[]}}setOptions(s){switch(s){case"Active":this.optionArray=[{name:"Post Interest",icon:"table",taskPermissionName:"POSTINTEREST_RECURRINGDEPOSITACCOUNT"},{name:"Add Charge",icon:"plus",taskPermissionName:"POSTINTEREST_RECURRINGDEPOSITACCOUNT"}];break;case"Submitted and pending approval":this.optionArray=[{name:"Reject",icon:"ban",taskPermissionName:"REJECT_RECURRINGDEPOSITACCOUNT"},{name:"Withdrawn by Client",icon:"arrow-down",taskPermissionName:"WITHDRAW_RECURRINGDEPOSITACCOUNT"},{name:"Add Charge",icon:"plus",taskPermissionName:"ADDCHARGE_RECURRINGDEPOSITACCOUNT"},{name:"Delete",icon:"trash",taskPermissionName:"DELETE_RECURRINGDEPOSITACCOUNT"}];break;case"Matured":this.optionArray=[{name:"Add Charge",icon:"plus",taskPermissionName:"ADDCHARGE_RECURRINGDEPOSITACCOUNT"}];break;case"Approved":default:this.optionArray=[]}}addOption(s){this.optionArray.push(s)}addButton(s){this.buttonsArray.push(s)}};var xi=()=>({confirm:!0}),Jt=(()=>{class e{constructor(a,l){this.dialogRef=a,this.data=l}static{this.\u0275fac=function(l){return new(l||e)(C(jn),C(Gn))}}static{this.\u0275cmp=A({type:e,selectors:[["mifosx-recurring-deposit-confirmation-action"]],decls:20,vars:10,consts:[["mat-dialog-title",""],["mat-dialog-content",""],["align","end"],["mat-raised-button","","mat-dialog-close",""],["mat-raised-button","","color","warn",3,"mat-dialog-close"]],template:function(l,p){l&1&&(n(0,"h1",0),t(1),i(),t(2,`
`),n(3,"div",1),t(4,`
  `),n(5,"p"),t(6),i(),t(7,`
`),i(),t(8,`
...
`),i(),t(19,`
`)),l&2&&(r(),u(p.data.heading),r(5),u(p.data.dialogContext),r(6),u(c(13,5,"labels.buttons.Cancel")),r(3),d("mat-dialog-close",z(9,xi)),r(),x(`
  ...
  `))},dependencies:[I,O,V,E,Hn,$n,zn,Un],encapsulation:2})}}return e})();var fi=()=>["./general"],_i=()=>["./interest-rate-chart"],Ci=()=>["./charges"],hi=()=>["./transactions"],Di=()=>["./standing-instructions-tab"],vi=e=>["./datatables",e];function bi(e,s){if(e&1&&(n(0,"span",31),t(1,`
                ...
                `),i()),e&2){let a=_();r(2),bt("accountNo",a.recurringDepositsAccountData.clientAccountNo)}}function Si(e,s){if(e&1&&(n(0,"div",32),t(1,`
  ...
  `),i(),t(98,`
`),i(),t(99,`
`)),l&2){let g=R(57),h=R(71),T=R(76),$=R(83),wt=R(93);r(10),bt("matTooltip",c(11,28,"tooltips.Recurring Deposits Account")),d("src","assets/images/recurring-deposits_account_placeholder.png",Bn),r(15),d("ngClass",c(26,30,p.recurringDepositsAccountData.status.code))("matTooltip",p.recurringDepositsAccountData.status.value),r(2),M(`
                `,c(28,32,"labels.inputs.Recurring Deposit"),` :
                `,p.recurringDepositsAccountData.depositProductName,`
                `),r(2),bt("accountNo",p.recurringDepositsAccountData.accountNo),r(4),oe(`
                ...
                `),r(3),d("ngIf",p.recurringDepositsAccountData.clientAccountNo),r(4),d("ngIf",!p.recurringDepositsAccountData.status.rejected&&!p.recurringDepositsAccountData.status.submittedAndPendingApproval),r(4),d("matMenuTriggerFor",g),r(15),d("ngForOf",p.buttonConfig.singleButtons),r(2),d("ngIf",p.buttonConfig.options.length),r(7),d("tabPanel",wt),r(2),d("routerLink",z(44,fi))("active",h.isActive),r(2),x(`
        `,c(73,38,"labels.inputs.General"),`
      `),r(3),d("routerLink",z(45,_i))("active",T.isActive),r(2),x(`
        `,c(78,40,"labels.inputs.Interest Rate Chart"),`
      `),r(3),d("ngIf",p.showTransactions),r(2),d("routerLink",z(46,Ci))("active",$.isActive),r(2),x(`
        `,c(85,42,"labels.inputs.Charges"),`
      `),r(3),d("ngIf",p.recurringDepositsAccountData.clientId),r(2),d("ngForOf",p.savingsDatatables)}},dependencies:[I,be,Mt,F,Ge,Te,O,L,W,lt,pe,E,Qn,Kn,Yn,ce,Wn,ci,Ie,We,He,ut,Le,ze,Zn,ti,qn,ei,Vn,ai],encapsulation:2})}}return e})();function wi(e,s){e&1&&(n(0,"th",17),t(1),o(2,"translate"),i()),e&2&&(r(),u(c(2,1,"labels.inputs.Period")))}function Fi(e,s){if(e&1&&(n(0,"td",18),t(1),o(2,"translateKey"),i()),e&2){let a=s.$implicit;r(),oe(`
          `,a.fromPeriod," - ",a.toPeriod,"\xA0",w(2,3,a.periodType.value,"catalogs"),`
        `)}}function Bi(e,s){e&1&&(n(0,"th",17),t(1),o(2,"translate"),i()),e&2&&(r(),u(c(2,1,"labels.inputs.Amount Range")))}function Ni(e,s){if(e&1&&(n(0,"td",18),t(1),o(2,"formatNumber"),o(3,"formatNumber"),i()),e&2){let a=s.$implicit;r(),M(`
          `,c(2,2,a.amountRangeFrom)," - ",c(3,4,a.amountRangeTo),`
        `)}}function ki(e,s){e&1&&(n(0,"th",17),t(1),o(2,"translate"),i()),e&2&&(r(),u(c(2,1,"labels.inputs.Interest")))}function Vi(e,s){if(e&1&&(n(0,"td",18),t(1),o(2,"formatNumber"),i()),e&2){let a=s.$implicit;r(),x("",c(2,1,a.annualInterestRate)," %")}}function qi(e,s){e&1&&(n(0,"th",17),t(1),o(2,"translate"),i()),e&2&&(r(),u(c(2,1,"labels.inputs.Description")))}function ji(e,s){if(e&1&&(n(0,"td",18),t(1),i()),e&2){let a=s.$implicit;r(),u(a.description)}}function Gi(e,s){e&1&&(n(0,"th",17),t(1),o(2,"translate"),i()),e&2&&(r(),u(c(2,1,"labels.inputs.Actions")))}function Ui(e,s){e&1&&(n(0,"span"),t(1,`
            ...
            `))}function $i(e,s){if(e&1){let a=y();n(0,"td",18),t(1,`
          ...
          `),i(),t(8,`
        `),i()}if(e&2){let a=s.dataIndex,l=_();r(4),d("ngIf",l.expandChartSlabIndex!==a),r(2),d("ngIf",l.expandChartSlabIndex===a)}}function zi(e,s){e&1&&(n(0,"th",17),t(1),o(2,"translate"),i()),e&2&&(r(),u(c(2,1,"labels.inputs.Entity Type")))}function Li(e,s){if(e&1&&(n(0,"td",18),t(1),i()),e&2){let a=s.$implicit;r(),x(`
                    `,a.entityType.value,`
                  `)}}function Wi(e,s){e&1&&(n(0,"th",17),t(1),o(2,"translate"),i()),e&2&&(r(),u(c(2,1,"labels.inputs.Attribute Name")))}function Ki(e,s){if(e&1&&(n(0,"td",18),t(1),i()),e&2){let a=s.$implicit;r(),x(`
                    `,a.attributeName.value,`
                  `)}}function Qi(e,s){e&1&&(n(0,"th",17),t(1),o(2,"translate"),i()),e&2&&(r(),u(c(2,1,"labels.inputs.Condition Type")))}function Yi(e,s){if(e&1&&(n(0,"td",18),t(1),o(2,"titlecase"),i()),e&2){let a=s.$implicit;r(),x(`
                    `,c(2,1,a.conditionType.value),`
                  `)}}function Ji(e,s){e&1&&(n(0,"th",17),t(1),o(2,"translate"),i()),e&2&&(r(),u(c(2,1,"labels.inputs.Attribute Value")))}function Xi(e,s){if(e&1&&(n(0,"td",35),t(1),i()),e&2){let a=s.$implicit;d("ngSwitch",a.attributeName),r(),x(`
                    `,a.attributeValueDesc,`
                  `)}}function Zi(e,s){e&1&&(n(0,"th",17),t(1),o(2,"translate"),i()),e&2&&(r(),u(c(2,1,"labels.inputs.Incentive Type")))}function ta(e,s){if(e&1&&(n(0,"td",18),t(1),i()),e&2){let a=s.$implicit;r(),x(`
                    `,a.incentiveType.value,`
                  `)}}function ea(e,s){e&1&&(n(0,"th",17),t(1),o(2,"translate"),i()),e&2&&(r(),u(c(2,1,"labels.inputs.Interest")))}function na(e,s){if(e&1&&(n(0,"td",18),t(1),o(2,"formatNumber"),i()),e&2){let a=s.$implicit;r(),x(`
                    `,c(2,1,a.amount),`
                  `)}}function ia(e,s){e&1&&f(0,"tr",36)}function aa(e,s){e&1&&f(0,"tr",37)}function ra(e,s){if(e&1&&(n(0,"table",27),t(1,`
                `),D(2,28),t(3,`
                  `),m(4,zi,3,3,"th",7),t(5,`
                  `),m(6,Li,2,1,"td",8),t(7,`
                `),v(),t(8,`
                ...
                `),D(30,33),t(31,`
                  ...
                  `),m(34,ta,2,1,"td",8),t(35,`
                `),v(),t(36,`

                `),D(37,34),t(38,`
                  `),m(39,ea,3,3,"th",7),t(40,`
                  `),m(41,na,3,3,"td",8),t(42,`
                `),v(),t(43,`

                `),m(44,ia,1,0,"tr",14),t(45,`
                `),m(46,aa,1,0,"tr",15),t(47,`
              `),i()),e&2){let a=_().$implicit,l=_();d("dataSource",a.incentives),r(44),d("matHeaderRowDef",l.incentivesDisplayedColumns),r(2),d("matRowDefColumns",l.incentivesDisplayedColumns)}}function oa(e,s){if(e&1&&(n(0,"td",18),t(1,`
          `),n(2,"div",23),t(3,`
            `),n(4,"mat-card",24),t(5,`
              `),n(6,"h4",25),t(7),o(8,"translate"),i(),t(9,`

              `),m(10,ra,48,3,"table",26),t(11,`
            `),i(),t(12,`
          `),i(),t(13,`
...
`)),l&2&&(r(7),u(c(8,5,"labels.heading.All Interest Rates")),r(7),d("dataSource",p.interestRateChartData),r(43),d("matHeaderRowDef",p.chartSlabsDisplayedColumns),r(2),d("matRowDefColumns",p.chartSlabsDisplayedColumns),r(2),d("matRowDefColumns",p.chartSlabsIncentivesDisplayedColumns))},dependencies:[I,F,Se,Pe,O,W,V,E,Ft,Bt,Vt,kt,qt,Nt,jt,ut,Gt,Ht,Ut,$t,Yt],styles:[".tab-container[_ngcontent-%COMP%]{padding:1%;margin:1%}.tab-container[_ngcontent-%COMP%]   h3[_ngcontent-%COMP%]{margin:1% auto}.tab-container[_ngcontent-%COMP%]   table[_ngcontent-%COMP%]{width:100%}.tab-container[_ngcontent-%COMP%]   table[_ngcontent-%COMP%]   tr.incentives-row[_ngcontent-%COMP%]{height:0}.tab-container[_ngcontent-%COMP%]   table[_ngcontent-%COMP%]   tr.incentives-row[_ngcontent-%COMP%] > td[_ngcontent-%COMP%]{padding:0}.tab-container[_ngcontent-%COMP%]   table[_ngcontent-%COMP%]   tr.incentives-row[_ngcontent-%COMP%]   .incentives[_ngcontent-%COMP%]{overflow:hidden}.tab-container[_ngcontent-%COMP%]   table[_ngcontent-%COMP%]   tr.incentives-row[_ngcontent-%COMP%]   .mat-card[_ngcontent-%COMP%]{border-radius:0}"],data:{animation:[Me("expandChartSlab",[re("collapsed",ae({height:"0px",minHeight:"0"})),re("expanded",ae({height:"*"})),Ae("expanded <=> collapsed",ye("225ms cubic-bezier(0.4, 0.0, 0.2, 1)"))])]}})}}return e})();var la=e=>["/","journal-entry","view",e];function ma(e,s){if(e&1){let a=y();n(0,"div",23),t(1,`
      ...
      `),i()}if(e&2){let a=_();r(2),d("formControl",a.hideReversedParam),r(),x(`
          ...
          `,c(8,6,"labels.inputs.Hide Accruals"),"")}}function da(e,s){e&1&&(n(0,"th",25),t(1,"#"),i())}function ua(e,s){if(e&1){let a=y();n(0,"td",26),b("click",function(){let p=S(a).$implicit,g=_();return P(g.showTransactions(p))}),t(1),i()}if(e&2){let a=s.index;r(),x(`
          `,a+1,`
        `)}}function ga(e,s){e&1&&(n(0,"th",25),t(1),o(2,"translate"),i()),e&2&&(r(),u(c(2,1,"labels.inputs.ID")))}function xa(e,s){if(e&1){let a=y();n(0,"td",27),b("click",function(){let p=S(a).$implicit,g=_();return P(g.showTransactions(p))}),t(1),i()}if(e&2){let a=s.$implicit,l=_();d("ngClass",l.savingsTransactionColor(a)),r(),x(`
          `,a.id,`
        `)}}function fa(e,s){e&1&&(n(0,"th",25),t(1),o(2,"translate"),i()),e&2&&(r(),u(c(2,1,"labels.inputs.Transaction Date")))}function _a(e,s){if(e&1){let a=y();n(0,"td",27),b("click",function(){let p=S(a).$implicit,g=_();return P(g.showTransactions(p))}),t(1),o(2,"dateFormat"),i()}if(e&2){let a=s.$implicit,l=_();d("ngClass",l.savingsTransactionColor(a)),r(),x(`
          `,c(2,2,a.date),`
        `)}}function Ca(e,s){e&1&&(n(0,"th",25),t(1),o(2,"translate"),i()),e&2&&(r(),u(c(2,1,"labels.inputs.Transaction Type")))}function ha(e,s){if(e&1){let a=y();n(0,"td",27),b("click",function(){let p=S(a).$implicit,g=_();return P(g.showTransactions(p))}),t(1),i()}if(e&2){let a=s.$implicit,l=_();d("ngClass",l.savingsTransactionColor(a)),r(),x(`
          `,a.transactionType.value,`
        `)}}function Da(e,s){e&1&&(n(0,"th",28),t(1),o(2,"translate"),i()),e&2&&(r(),u(c(2,1,"labels.inputs.Debit")))}function va(e,s){if(e&1){let a=y();n(0,"td",29),b("click",function(){let p=S(a).$implicit,g=_();return P(g.showTransactions(p))}),t(1),i()}if(e&2){let a=s.$implicit,l=_();d("ngClass",l.savingsTransactionColor(a)),r(),x(`
          `,l.isDebit(a.transactionType)?a.amount:"N/A",`
        `)}}function ba(e,s){e&1&&(n(0,"th",28),t(1),o(2,"translate"),i()),e&2&&(r(),u(c(2,1,"labels.inputs.Credit")))}function Sa(e,s){if(e&1){let a=y();n(0,"td",29),b("click",function(){let p=S(a).$implicit,g=_();return P(g.showTransactions(p))}),t(1),i()}if(e&2){let a=s.$implicit,l=_();d("ngClass",l.savingsTransactionColor(a)),r(),x(`
          `,l.isDebit(a.transactionType)?"N/A":a.amount,`
        `)}}function Pa(e,s){e&1&&(n(0,"th",28),t(1),o(2,"translate"),i()),e&2&&(r(),u(c(2,1,"labels.inputs.Balance")))}function Ta(e,s){if(e&1){let a=y();n(0,"td",29),b("click",function(){let p=S(a).$implicit,g=_();return P(g.showTransactions(p))}),t(1),o(2,"formatNumber"),i()}if(e&2){let a=s.$implicit,l=_();d("ngClass",l.savingsTransactionColor(a)),r(),x(`
          `,c(2,2,a.runningBalance),`
        `)}}function Ma(e,s){e&1&&(n(0,"th",25),t(1),o(2,"translate"),i()),e&2&&(r(),u(c(2,1,"labels.inputs.Actions")))}function ya(e,s){if(e&1){let a=y();n(0,"td",30),t(1,`
          `),n(2,"button",31),t(3,`
  ...
  `),n(9,"div",3),t(10,`
    `),n(11,"table",4,0),t(13,`
      `),D(14,5),t(15,`
        ...
        `),m(18,Fa,2,2,"td",7),t(19,`
      `),v(),t(20,`

      `),D(21,8),t(22,`
        `),m(23,Ba,3,3,"th",6),t(24,`
        `),m(25,Na,2,2,"td",7),t(26,`
      `),v(),t(27,`

      `),D(28,9),t(29,`
        `),m(30,ka,3,3,"th",6),t(31,`
        `),m(32,Va,2,1,"td",7),t(33,`
      `),v(),t(34,`

      `),D(35,10),t(36,`
        `),m(37,qa,3,3,"th",6),t(38,`
        `),m(39,ja,2,2,"td",7),t(40,`
      `),v(),t(41,`

      `),D(42,11),t(43,`
        `),m(44,Ga,3,3,"th",6),t(45,`
        `),m(46,Ua,2,2,"td",7),t(47,`
      `),v(),t(48,`

      `),D(49,12),t(50,`
        `),m(51,Ha,3,3,"th",6),t(52,`
        `),m(53,$a,4,6,"td",7),t(54,`
      `),v(),t(55,`

      `),D(56,13),t(57,`
        `),m(58,za,3,3,"th",6),t(59,`
        `),m(60,Ja,8,3,"td",7),t(61,`
      `),v(),t(62,`

      `),m(63,Xa,1,0,"tr",14),t(64,`
      `),m(65,Za,1,0,"tr",15),t(66,`
    `),i(),t(67,`
  `),i(),t(68,`
`),i(),t(69,`
`)),l&2&&(r(5),u(c(6,4,"labels.heading.All Standing Instructions")),r(6),d("dataSource",p.dataSource),r(52),d("matHeaderRowDef",p.displayedColumns),r(2),d("matRowDefColumns",p.displayedColumns))},dependencies:[I,F,O,L,V,Rt,pe,E,Bt,Vt,kt,qt,Nt,jt,ce,Gt,Ht,Ut,$t],styles:[".tab-container[_ngcontent-%COMP%]{padding:1%;margin:1%}.tab-container[_ngcontent-%COMP%]   h3[_ngcontent-%COMP%]{margin:1% auto}.tab-container[_ngcontent-%COMP%]   .action-button[_ngcontent-%COMP%]{margin-left:auto}.tab-container[_ngcontent-%COMP%]   table[_ngcontent-%COMP%]{width:100%}.tab-container[_ngcontent-%COMP%]   table[_ngcontent-%COMP%]   .account-action-button[_ngcontent-%COMP%]{min-width:26px;padding:0 6px;margin:4px;line-height:25px}"]})}}return e})();var tr=["chargesTable"],er=()=>[2e3];function nr(e,s){e&1&&(n(0,"th",21),t(1),o(2,"translate"),i()),e&2&&(r(),u(c(2,1,"labels.inputs.name")))}function ir(e,s){if(e&1&&(n(0,"td",22),t(1),i()),e&2){let a=s.$implicit;r(),u(a.name)}}function ar(e,s){e&1&&(n(0,"th",21),t(1),o(2,"translate"),i()),e&2&&(r(),u(c(2,1,"labels.inputs.Fee/Penalty")))}function rr(e,s){if(e&1&&(n(0,"td",22),t(1),i()),e&2){let a=s.$implicit;r(),u(a.penalty===!0?"Penalty":"Fee")}}function or(e,s){e&1&&(n(0,"th",21),t(1),o(2,"translate"),i()),e&2&&(r(),u(c(2,1,"labels.inputs.Payment Due At")))}function pr(e,s){if(e&1&&(n(0,"td",22),t(1),i()),e&2){let a=s.$implicit;r(),u(a.chargeTimeType.value)}}function cr(e,s){e&1&&(n(0,"th",21),t(1),o(2,"translate"),i()),e&2&&(r(),u(c(2,1,"labels.inputs.Due As Of")))}function sr(e,s){if(e&1&&(n(0,"td",22),t(1),o(2,"dateFormat"),i()),e&2){let a=s.$implicit;r(),u(c(2,1,a.dueDate))}}function lr(e,s){e&1&&(n(0,"th",21),t(1),o(2,"translate"),i()),e&2&&(r(),u(c(2,1,"labels.inputs.Repeats On")))}function mr(e,s){if(e&1&&(n(0,"td",22),t(1),o(2,"dateFormat"),i()),e&2){let a=s.$implicit;r(),x(`
          `,a.feeOnMonthDay?w(2,1,z(4,er).concat(a.feeOnMonthDay),"dd MMMM"):"Unassigned",`
        `)}}function dr(e,s){e&1&&(n(0,"th",21),t(1),o(2,"translate"),i()),e&2&&(r(),u(c(2,1,"labels.inputs.Calculation Type")))}function ur(e,s){if(e&1&&(n(0,"td",22),t(1),i()),e&2){let a=s.$implicit;r(),u(a.chargeCalculationType.value)}}function gr(e,s){e&1&&(n(0,"th",21),t(1),o(2,"translate"),i()),e&2&&(r(),u(c(2,1,"labels.inputs.Due")))}function xr(e,s){if(e&1&&(n(0,"td",22),t(1),i()),e&2){let a=s.$implicit;r(),M("",a.currency.displaySymbol,"\xA0",a.amount,"")}}function fr(e,s){e&1&&(n(0,"th",21),t(1),o(2,"translate"),i()),e&2&&(r(),u(c(2,1,"labels.inputs.Paid")))}function _r(e,s){if(e&1&&(n(0,"td",22),t(1),i()),e&2){let a=s.$implicit;r(),M("",a.currency.displaySymbol,"\xA0",a.amountPaid,"")}}function Cr(e,s){e&1&&(n(0,"th",21),t(1),o(2,"translate"),i()),e&2&&(r(),u(c(2,1,"labels.inputs.Waived")))}function hr(e,s){if(e&1&&(n(0,"td",22),t(1),i()),e&2){let a=s.$implicit;r(),M("",a.currency.displaySymbol,"\xA0",a.amountWaived,"")}}function Dr(e,s){e&1&&(n(0,"th",21),t(1),o(2,"translate"),i()),e&2&&(r(),u(c(2,1,"labels.inputs.Outstanding")))}function vr(e,s){if(e&1&&(n(0,"td",22),t(1),i()),e&2){let a=s.$implicit;r(),M(`
          `,a.currency.displaySymbol,"\xA0",a.amountOutstanding,`
        `)}}function br(e,s){e&1&&(n(0,"th",21),t(1),o(2,"translate"),i()),e&2&&(r(),u(c(2,1,"labels.inputs.Actions")))}function Sr(e,s){if(e&1){let a=y();n(0,"button",26),o(1,"translate"),b("click",function(p){S(a);let g=_(2).$implicit,h=_();return h.routeEdit(p),P(h.editCharge(g))}),t(2,`
              `),f(3,"i",27),t(4,`
            `),i()}e&2&&bt("matTooltip",c(1,1,"tooltips.Edit Charge"))}function Pr(e,s){if(e&1){let a=y();n(0,"button",28),o(1,"translate"),b("click",function(p){S(a);let g=_(2).$implicit,h=_();return h.routeEdit(p),P(h.deleteCharge(g.id))}),t(2,`
              `),f(3,"i",29),t(4,`
            `),i()}e&2&&bt("matTooltip",c(1,1,"tooltips.Delete Charge"))}function Tr(e,s){e&1&&(n(0,"span"),t(1,`
            `),m(2,Sr,5,3,"button",24),t(3,`
            `),m(4,Pr,5,3,"button",25),t(5,`
          `),i()),e&2&&(r(2),d("mifosxHasPermission","UPDATE_SAVINGSACCOUNTCHARGE"),r(2),d("mifosxHasPermission","DELETE_SAVINGSACCOUNTCHARGE"))}function Mr(e,s){if(e&1){let a=y();n(0,"button",26),o(1,"translate"),b("click",function(p){S(a);let g=_(3).$implicit,h=_();return h.routeEdit(p),P(h.payCharge(g.id))}),t(2,`
                `),f(3,"i",30),t(4,`
              `),i()}e&2&&bt("matTooltip",c(1,1,"tooltips.Pay Charge"))}function yr(e,s){if(e&1){let a=y();n(0,"button",26),o(1,"translate"),b("click",function(p){S(a);let g=_(3).$implicit,h=_();return h.routeEdit(p),P(h.waiveCharge(g.id))}),t(2,`
                `),f(3,"i",31),t(4,`
              `),i()}e&2&&bt("matTooltip",c(1,1,"tooltips.Waive Charge"))}function Ar(e,s){e&1&&(n(0,"span"),t(1,`
              `),m(2,Mr,5,3,"button",24),t(3,`
              `),m(4,yr,5,3,"button",24),t(5,`
            `),i()),e&2&&(r(2),d("mifosxHasPermission","PAY_SAVINGSACCOUNTCHARGE"),r(2),d("mifosxHasPermission","WAIVE_SAVINGSACCOUNTCHARGE"))}function Ir(e,s){if(e&1&&(n(0,"span"),t(1,`
            `),m(2,Ar,6,2,"span",23),t(3,`
          `),i()),e&2){let a=_().$implicit;r(2),d("ngIf",a.chargeTimeType.value==="Monthly Fee"||a.chargeTimeType.value==="Annual Fee"||a.chargeTimeType.value==="Specified due date")}}function Or(e,s){if(e&1&&(n(0,"td",22),t(1,`
          `),m(2,Tr,6,2,"span",23),t(3,`
          `),m(4,Ir,4,1,"span",23),t(5,`
        `),i()),e&2){let a=s.$implicit,l=_();r(2),d("ngIf",l.recurringDepositsAccountData.status.value==="Submitted and pending approval"),r(2),d("ngIf",l.recurringDepositsAccountData.status.value!=="Submitted and pending approval"&&a.amountOutstanding!==0)}}function Er(e,s){e&1&&f(0,"tr",32)}function Rr(e,s){e&1&&f(0,"tr",33)}var pn=(()=>{class e{constructor(a,l,p,g,h,T,$){this.route=a,this.savingsService=l,this.dateUtils=p,this.router=g,this.dialog=h,this.translateService=T,this.settingsService=$,this.showInactiveCharges=!1,this.displayedColumns=["name","feeOrPenalty","paymentDueAt","dueAsOf","repeatsOn","calculationType","due","paid","waived","outstanding","actions"],this.route.parent.data.subscribe(wt=>{this.recurringDepositsAccountData=wt.recurringDepositsAccountData,this.chargesData=this.recurringDepositsAccountData.charges})}ngOnInit(){let a=this.chargesData?this.chargesData.filter(l=>l.isActive):[];this.dataSource=new _e(a)}payCharge(a){let l=[new Re({controlName:"amount",label:"Amount",value:"",type:"number",required:!0}),new tn({controlName:"dueDate",label:"Payment Date",value:"",type:"date",required:!0})],p={title:`Pay Charge ${a}`,layout:{addButtonText:"Confirm"},formfields:l};this.dialog.open(fe,{data:p}).afterClosed().subscribe(h=>{if(h.data){let T=this.settingsService.language.code,$=this.settingsService.dateFormat,wt=K(B({},h.data.value),{dueDate:this.dateUtils.formatDate(h.data.value.dueDate,$),dateFormat:$,locale:T});this.savingsService.executeSavingsAccountChargesCommand(this.recurringDepositsAccountData.id,"paycharge",wt,a).subscribe(()=>{this.reload()})}})}waiveCharge(a){this.dialog.open(Jt,{data:{heading:this.translateService.instant("labels.heading.Waive Charge"),dialogContext:this.translateService.instant("labels.dialogContext.Are you sure you want to waive charge with id: ")+`${a} ?`}}).afterClosed().subscribe(p=>{p.confirm&&this.savingsService.executeSavingsAccountChargesCommand(this.recurringDepositsAccountData.id,"waive",{},a).subscribe(()=>{this.reload()})})}editCharge(a){let l=[new Re({controlName:"amount",label:"Amount",value:a.amount||a.amountOrPercentage,type:"number",required:!0})],p={title:`Edit Charge ${a.id}`,layout:{addButtonText:"Confirm"},formfields:l};this.dialog.open(fe,{data:p}).afterClosed().subscribe(h=>{if(h.data){let wt=K(B({},h.data.value),{dateFormat:"dd MMMM yyyy",locale:"en"});this.savingsService.editSavingsAccountCharge(this.recurringDepositsAccountData.id,wt,a.id).subscribe(()=>{this.reload()})}})}deleteCharge(a){this.dialog.open(se,{data:{deleteContext:`charge id:${a}`}}).afterClosed().subscribe(p=>{p.delete&&this.savingsService.deleteSavingsAccountCharge(this.recurringDepositsAccountData.id,a).subscribe(()=>{this.reload()})})}routeEdit(a){a.stopPropagation()}reload(){let a=this.recurringDepositsAccountData.clientId,l=this.router.url;this.router.navigateByUrl(`/clients/${a}/recurring-deposits-accounts`,{skipLocationChange:!0}).then(()=>this.router.navigate([l]))}static{this.\u0275fac=function(l){return new(l||e)(C(k),C(le),C(Q),C(H),C(ee),C(Oe),C(U))}}static{this.\u0275cmp=A({type:e,selectors:[["mifosx-charges-tab"]],viewQuery:function(l,p){if(l&1&&St(tr,7),l&2){let g;Pt(g=Tt())&&(p.chargesTableRef=g.first)}},decls:101,vars:6,consts:[["chargesTable",""],[1,"tab-container","mat-typography"],[1,"layout-row","align-start"],[1,"m-b-10"],[1,"mat-elevation-z1","m-b-25"],["mat-table","",3,"dataSource"],["matColumnDef","name"],["mat-header-cell","",4,"matHeaderCellDef"],["mat-cell","",4,"matCellDef"],["matColumnDef","feeOrPenalty"],["matColumnDef","paymentDueAt"],["matColumnDef","dueAsOf"],["matColumnDef","repeatsOn"],["matColumnDef","calculationType"],["matColumnDef","due"],["matColumnDef","paid"],["matColumnDef","waived"],["matColumnDef","outstanding"],["matColumnDef","actions"],["mat-header-row","",4,"matHeaderRowDef"],["mat-row","",4,"matRowDef","matRowDefColumns"],["mat-header-cell",""],["mat-cell",""],[4,"ngIf"],["class","account-action-button","mat-raised-button","","color","primary",3,"matTooltip","click",4,"mifosxHasPermission"],["class","account-action-button","mat-raised-button","","color","warn",3,"matTooltip","click",4,"mifosxHasPermission"],["mat-raised-button","","color","primary",1,"account-action-button",3,"click","matTooltip"],[1,"fa","fa-pencil"],["mat-raised-button","","color","warn",1,"account-action-button",3,"click","matTooltip"],[1,"fa","fa-trash"],[1,"fa","fa-dollar"],[1,"fa","fa-flag"],["mat-header-row",""],["mat-row",""]],template:function(l,p){l&1&&(n(0,"div",1),t(1,`
  `),n(2,"div",2),t(3,`
    `),n(4,"div",3),t(5,`
      `),n(6,"h3"),t(7),o(8,"translate"),i(),t(9,`
    `),i(),t(10,`
  ...
  `),n(12,"div",4),t(13,`
    `),n(14,"table",5,0),t(16,`
      `),D(17,6),t(18,`
        `),m(19,nr,3,3,"th",7),t(20,`
        `),m(21,ir,2,1,"td",8),t(22,`
      `),v(),t(23,`

      `),D(24,9),t(25,`
        `),m(26,ar,3,3,"th",7),t(27,`
        `),m(28,rr,2,1,"td",8),t(29,`
      `),v(),t(30,`

      `),D(31,10),t(32,`
        `),m(33,or,3,3,"th",7),t(34,`
        `),m(35,pr,2,1,"td",8),t(36,`
      `),v(),t(37,`

      `),D(38,11),t(39,`
        `),m(40,cr,3,3,"th",7),t(41,`
        `),m(42,sr,3,3,"td",8),t(43,`
      `),v(),t(44,`

      `),D(45,12),t(46,`
        `),m(47,lr,3,3,"th",7),t(48,`
        `),m(49,mr,3,5,"td",8),t(50,`
      `),v(),t(51,`

      `),D(52,13),t(53,`
        `),m(54,dr,3,3,"th",7),t(55,`
        `),m(56,ur,2,1,"td",8),t(57,`
      `),v(),t(58,`

      `),D(59,14),t(60,`
        `),m(61,gr,3,3,"th",7),t(62,`
        `),m(63,xr,2,2,"td",8),t(64,`
      `),v(),t(65,`

      `),D(66,15),t(67,`
        `),m(68,fr,3,3,"th",7),t(69,`
        `),m(70,_r,2,2,"td",8),t(71,`
      `),v(),t(72,`

      `),D(73,16),t(74,`
        `),m(75,Cr,3,3,"th",7),t(76,`
        `),m(77,hr,2,2,"td",8),t(78,`
      `),v(),t(79,`

      `),D(80,17),t(81,`
        `),m(82,Dr,3,3,"th",7),t(83,`
        `),m(84,vr,2,2,"td",8),t(85,`
      `),v(),t(86,`

      `),D(87,18),t(88,`
        `),m(89,br,3,3,"th",7),t(90,`
        `),m(91,Or,6,2,"td",8),t(92,`
      `),v(),t(93,`

      `),m(94,Er,1,0,"tr",19),t(95,`
      `),m(96,Rr,1,0,"tr",20),t(97,`
    `),i(),t(98,`
  `),i(),t(99,`
`),i(),t(100,`
`)),l&2&&(r(7),u(c(8,4,"labels.heading.All Charges")),r(7),d("dataSource",p.dataSource),r(80),d("matHeaderRowDef",p.displayedColumns),r(2),d("matRowDefColumns",p.displayedColumns))},dependencies:[I,F,O,V,Rt,pe,E,Bt,Vt,kt,qt,Nt,jt,ce,Gt,Ht,Ut,$t],styles:[".tab-container[_ngcontent-%COMP%]{padding:1%;margin:1%}.tab-container[_ngcontent-%COMP%]   h3[_ngcontent-%COMP%]{margin:1% auto}.tab-container[_ngcontent-%COMP%]   .action-button[_ngcontent-%COMP%]{margin-left:auto}.tab-container[_ngcontent-%COMP%]   table[_ngcontent-%COMP%]{width:100%}.tab-container[_ngcontent-%COMP%]   table[_ngcontent-%COMP%]   .account-action-button[_ngcontent-%COMP%]{min-width:26px;padding:0 6px;margin:4px;line-height:25px}"]})}}return e})();var cn=(()=>{class e{constructor(a){this.route=a,this.entityId=this.route.parent.parent.snapshot.paramMap.get("recurringDepositAccountId"),this.route.data.subscribe(l=>{this.entityDatatable=l.savingsDatatable,this.multiRowDatatableFlag=this.entityDatatable.columnHeaders[0].columnName==="id"})}static{this.\u0275fac=function(l){return new(l||e)(C(k))}}static{this.\u0275cmp=A({type:e,selectors:[["mifosx-datatable-tabs"]],decls:6,vars:3,consts:[[1,"tab-container","mat-typography"],["entityType","Recurring Deposit",3,"entityId","multiRowDatatableFlag","entityDatatable"]],template:function(l,p){l&1&&(n(0,"div",0),t(1,`
  `),n(2,"mifosx-entity-datatable-tab",1),t(3,`
  `),i(),t(4,`
`),i(),t(5,`
`)),l&2&&(r(2),d("entityId",p.entityId)("multiRowDatatableFlag",p.multiRowDatatableFlag)("entityDatatable",p.entityDatatable))},dependencies:[I,O,pi],encapsulation:2})}}return e})();function wr(e,s){if(e&1&&(n(0,"mat-option",13),t(1),i()),e&2){let a=s.$implicit;d("value",a.id),r(),x(`
          `,a.name,`
        `)}}function Fr(e,s){if(e&1){let a=y();n(0,"mat-form-field",14),b("click",function(){S(a);let p=R(11);return P(p.open())}),t(1,`
  ...
  `),n(2,"div",2),t(3,`
    ...
    `),m(25,Fr,22,16,"mat-form-field",6),t(26,`

    `),m(27,Nr,11,4,"mat-form-field",7),t(28,`

    `),m(29,kr,9,6,"mat-form-field",7),t(30,`
  `),i(),t(31,`
  ...
  `),i(),t(46,`
`),i(),t(47,`
`)),l&2){let g;d("formGroup",p.recurringDepositAccountDetailsForm),r(7),u(c(8,12,"labels.inputs.Product Name")),r(5),d("ngForOf",p.productData),r(4),M(`
  ...
  `),i(),t(103,`
`),i(),t(104,`
`)),l&2&&(d("formGroup",p.recurringDepositAccountTermsForm),r(7),u(c(8,23,"labels.inputs.Interest Compounding Period")),r(5),d("ngForOf",p.interestCompoundingPeriodTypeData),r(4),M(`
        `,c(17,25,"labels.inputs.Interest Compounding Period")," ",c(18,27,"labels.commons.is"),`
        `),r(4),u(c(21,29,"labels.commons.required")),r(8),u(c(29,31,"labels.inputs.Interest Posting Period")),r(5),d("ngForOf",p.interestPostingPeriodTypeData),r(4),M(`
        `,c(38,33,"labels.inputs.Interest Posting Period")," ",c(39,35,"labels.commons.is"),`
        `),r(4),u(c(42,37,"labels.commons.required")),r(8),u(c(50,39,"labels.inputs.Interest Calculated using")),r(5),d("ngForOf",p.interestCalculationTypeData),r(4),M(`
        `,c(59,41,"labels.inputs.Interest Calculated using")," ",c(60,43,"labels.commons.is"),`
        `),r(4),u(c(63,45,"labels.commons.required")),r(8),u(c(71,47,"labels.inputs.Days in Year")),r(5),d("ngForOf",p.interestCalculationDaysInYearTypeData),r(4),M(`
    ...
    `),r(4),x(`
      ...
      `))},dependencies:[I,Mt,O,it,Y,nt,st,at,rt,Z,X,mt,Et,Ot,V,E,Ft,Qt,ut,ne],encapsulation:2})}}return e})();function Ur(e,s){if(e&1&&(n(0,"mat-option",32),t(1),o(2,"translateKey"),i()),e&2){let a=s.$implicit;d("value",a.id),r(),x(`
          `,w(2,2,a.value,"catalogs"),`
        `)}}function Hr(e,s){if(e&1&&(n(0,"mifosx-input-amount",33),t(1,`
    `),i()),e&2){let a=_();d("currency",a.currency)("isRequired",!0)("inputFormControl",a.recurringDepositAccountSettingsForm.controls.mandatoryRecommendedDepositAmount)("inputLabel","Recurring Deposit Amount")}}function $r(e,s){if(e&1&&(n(0,"mat-option",32),t(1),o(2,"translateKey"),i()),e&2){let a=s.$implicit;d("value",a.id),r(),x(`
          `,w(2,2,a.value,"catalogs"),`
        `)}}function zr(e,s){if(e&1&&(n(0,"mat-option",32),t(1),o(2,"translateKey"),i()),e&2){let a=s.$implicit;d("value",a.id),r(),x(`
            `,w(2,2,a.value,"catalogs"),`
          `)}}function Lr(e,s){if(e&1){let a=y();D(0),t(1,`
      `),n(2,"mat-form-field",34),b("click",function(){S(a);let p=R(13);return P(p.open())}),t(3,`
  ...
  `),n(2,"div",2),t(3,`
    ...
    `),n(29,"mat-form-field",7),t(30,`
      ...
      `),n(35,"mat-select",9),t(36,`
        `),m(37,Ur,3,5,"mat-option",10),t(38,`
      `),i(),t(39,`
    `),i(),t(40,`

    `),n(41,"h4",6),t(42),o(43,"translate"),i(),t(44,`
    `),m(45,Hr,2,4,"mifosx-input-amount",11),t(46,`
    ...
    `),n(60,"mat-form-field",7),t(61,`
      ...
      `),n(66,"mat-select",13),t(67,`
        `),m(68,$r,3,5,"mat-option",10),t(69,`
      `),i(),t(70,`
    `),i(),t(71,`

    `),n(72,"mat-checkbox",14),t(73),o(74,"translate"),i(),t(75,`

    `),m(76,Lr,59,35,"ng-container",15),t(77,`
    ...
    `),n(102,"mat-form-field",7),t(103,`
      ...
      `),n(108,"mat-select",18),t(109,`
        `),m(110,Wr,3,5,"mat-option",10),t(111,`
      `),i(),t(112,`
    ...
    `),n(136,"mat-form-field",7),t(137,`
      ...
      `),n(142,"mat-select",20),t(143,`
        `),m(144,Kr,3,5,"mat-option",10),t(145,`
      `),i(),t(146,`
    `),i(),t(147,`
    ...
    `),n(161,"mat-form-field",7),t(162,`
      ...
      `),n(167,"mat-select",22),t(168,`
        `),m(169,Qr,3,5,"mat-option",10),t(170,`
      `),i(),t(171,`
    `),i(),t(172,`
    ...
    `),n(192,"mat-form-field",7),t(193,`
      ...
      `),n(198,"mat-select",25),t(199,`
        `),m(200,Yr,3,5,"mat-option",10),t(201,`
      `),i(),t(202,`
    `),i(),t(203,`
    ...
    `),m(214,Xr,12,7,"ng-container",15),t(215,`
  `),i(),t(216,`
...
`)),l&2&&(d("formGroup",p.recurringDepositAccountSettingsForm),r(5),x(`
    ...
    `),r(3),d("ngIf",!p.recurringDepositAccountSettingsForm.value.isCalendarInherited),r(5),u(c(82,65,"labels.heading.Minimum Deposit Term")),r(6),u(c(88,67,"labels.inputs.Frequency")),r(6),M(`
        `,c(94,69,"labels.inputs.Minimum Deposit Term Frequency")," ",c(95,71,"labels.commons.is"),`
        `),r(4),u(c(98,73,"labels.commons.required")),r(8),u(c(106,75,"labels.inputs.Frequency Type")),r(5),d("ngForOf",p.periodFrequencyTypeData),r(4),M(`
    ...
    `),r(4),x(`
      ...
      `))},dependencies:[I,Mt,F,O,it,ct,Ee,Y,nt,st,at,rt,Z,X,mt,xt,dt,Et,Ot,_t,Ct,ft,V,E,Ft,Ue,we,$e,Qt,ut,ne],styles:["h4[_ngcontent-%COMP%]{font-weight:500;margin:1em 0}h3[_ngcontent-%COMP%]{font-weight:500}mat-divider[_ngcontent-%COMP%]{margin:1em 0 2em}.margin-v[_ngcontent-%COMP%]{margin:1em 0}.margin-b[_ngcontent-%COMP%]{margin:0 0 1em}.margin-t[_ngcontent-%COMP%]{margin-top:1em}"]})}}return e})();function Zr(e,s){if(e&1&&(n(0,"mat-option",24),t(1),i()),e&2){let a=s.$implicit;d("value",a),r(),x(`
        `,a.name,`
      `)}}function to(e,s){e&1&&(n(0,"th",25),t(1),o(2,"translate"),i()),e&2&&(r(),u(c(2,1,"labels.inputs.name")))}function eo(e,s){if(e&1&&(n(0,"td",26),t(1),i()),e&2){let a=s.$implicit;r(),x(`
        `,a.name+", "+a.currency.displaySymbol,`
      `)}}function no(e,s){e&1&&(n(0,"th",25),t(1),o(2,"translate"),i()),e&2&&(r(),u(c(2,1,"labels.inputs.Type")))}function io(e,s){if(e&1&&(n(0,"td",26),t(1),o(2,"translateKey"),i()),e&2){let a=s.$implicit;r(),x(`
        `,w(2,1,a.chargeCalculationType.value,"catalogs"),`
      `)}}function ao(e,s){e&1&&(n(0,"th",25),t(1),o(2,"translate"),i()),e&2&&(r(),u(c(2,1,"labels.inputs.Amount")))}function ro(e,s){if(e&1){let a=y();n(0,"td",26),t(1),o(2,"formatNumber"),n(3,"button",27),b("click",function(){let p=S(a).$implicit,g=_();return P(g.editChargeAmount(p))}),t(4,`
          `),f(5,"fa-icon",28),t(6,`
        `),i(),t(7,`
      `),i()}if(e&2){let a=s.$implicit;r(),x(`
        `,c(2,1,a.amount),`
        `)}}function oo(e,s){e&1&&(n(0,"th",25),t(1),o(2,"translate"),i()),e&2&&(r(),u(c(2,1,"labels.inputs.Collected On")))}function po(e,s){if(e&1&&(n(0,"td",26),t(1),o(2,"translateKey"),i()),e&2){let a=s.$implicit;r(),x(`
        `,w(2,1,a.chargeTimeType.value,"catalogs"),`
      `)}}function co(e,s){e&1&&(n(0,"th",25),t(1),o(2,"translate"),i()),e&2&&(r(),u(c(2,1,"labels.inputs.Date")))}function so(e,s){if(e&1&&(n(0,"span"),t(1),o(2,"dateFormat"),i()),e&2){let a=_().$implicit;r(),x(`
          `,c(2,1,a.dueDate)||"Unassigned",`
        `)}}function lo(e,s){if(e&1&&(n(0,"span"),t(1),o(2,"dateFormat"),i()),e&2){let a=_().$implicit;r(),x(`
          `,c(2,1,a.feeOnMonthDay)||"Unassigned",`
        `)}}function mo(e,s){e&1&&(n(0,"span"),t(1),o(2,"translate"),i()),e&2&&(r(),x(`
          `,c(2,1,"labels.inputs.N/A"),`
        `))}function uo(e,s){if(e&1){let a=y();n(0,"button",27),b("click",function(){S(a);let p=_().$implicit,g=_();return P(g.editChargeDate(p))}),t(1,`
          `),f(2,"fa-icon",28),t(3,`
      ...
      `),i()),e&2){let a=s.$implicit;r(2),d("ngIf",a.chargeTimeType.value==="Specified due date"||a.chargeTimeType.value==="Weekly Fee"),r(2),d("ngIf",a.chargeTimeType.value==="Monthly Fee"||a.chargeTimeType.value==="Annual Fee"),r(2),d("ngIf",!(a.chargeTimeType.value==="Monthly Fee"||a.chargeTimeType.value==="Annual Fee"||a.chargeTimeType.value==="Specified due date"||a.chargeTimeType.value==="Weekly Fee")),r(2),d("ngIf",a.chargeTimeType.value==="Weekly Fee"||a.chargeTimeType.value==="Annual Fee"||a.chargeTimeType.value==="Specified due date")}}function xo(e,s){e&1&&(n(0,"th",25),t(1),o(2,"translate"),i()),e&2&&(r(),u(c(2,1,"labels.inputs.Repayments Every")))}function fo(e,s){if(e&1){let a=y();n(0,"button",27),b("click",function(){S(a);let p=_().$implicit,g=_();return P(g.editChargeFeeInterval(p))}),t(1,`
          `),f(2,"fa-icon",28),t(3,`
        `),i()}}function _o(e,s){if(e&1&&(n(0,"td",26),t(1),m(2,fo,4,0,"button",30),t(3,`
      `),i()),e&2){let a=s.$implicit;r(),x(`
        `,a.feeInterval||"Not Provided",`
        `),r(),d("ngIf",a.chargeTimeType.value==="Weekly Fee"||a.chargeTimeType.value==="Monthly Fee")}}function Co(e,s){e&1&&(n(0,"th",25),t(1),o(2,"translate"),i()),e&2&&(r(),u(c(2,1,"labels.inputs.Actions")))}function ho(e,s){if(e&1){let a=y();n(0,"td",26),t(1,`
        `),n(2,"button",31),b("click",function(){let p=S(a).$implicit,g=_();return P(g.deleteCharge(p))}),t(3,`
          `),f(4,"fa-icon",32),t(5,`
        `),i(),t(6,`
      `),i()}}function Do(e,s){e&1&&f(0,"tr",33)}function vo(e,s){e&1&&f(0,"tr",34)}var ge=(()=>{class e{constructor(a,l,p){this.dialog=a,this.dateUtils=l,this.settingsService=p,this.chargesDataSource=[],this.displayedColumns=["name","chargeCalculationType","amount","chargeTimeType","date","repaymentsEvery","action"],this.pristine=!0,this.isChargesPatched=!1,this.currency=null}ngOnInit(){this.chargesDataSource=[],this.recurringDepositsAccountTemplate.id&&this.recurringDepositsAccountTemplate.charges&&(this.chargesDataSource=this.recurringDepositsAccountTemplate.charges.map(a=>K(B({},a),{id:a.chargeId}))||[])}ngOnChanges(){this.currency==null&&(this.recurringDepositsAccountTemplate.currency?this.currency=this.recurringDepositsAccountTemplate.currency:this.recurringDepositsAccountProductTemplate&&this.recurringDepositsAccountProductTemplate.currency&&(this.currency=this.recurringDepositsAccountProductTemplate.currency)),this.recurringDepositsAccountProductTemplate&&(this.chargeData=this.recurringDepositsAccountProductTemplate.chargeOptions.filter(a=>a.currency.code===this.currency.code))}addCharge(a){this.chargesDataSource=this.chargesDataSource.concat([a.value]),a.value="",this.pristine=!1}editChargeAmount(a){let l=[new Re({controlName:"amount",label:"Amount",value:a.amount,type:"number",required:!1})],p={title:"Edit Charge Amount",layout:{addButtonText:"Confirm"},formfields:l};this.dialog.open(fe,{data:p}).afterClosed().subscribe(h=>{if(h.data){let T=K(B({},a),{amount:h.data.value.amount});this.chargesDataSource.splice(this.chargesDataSource.indexOf(a),1,T),this.chargesDataSource=this.chargesDataSource.concat([])}}),this.pristine=!1}editChargeDate(a){let l=[new tn({controlName:"date",label:"Date",value:a.dueDate||a.feeOnMonthDay||"",type:"datetime-local",required:!1})],p={title:"Edit Charge Date",layout:{addButtonText:"Confirm"},formfields:l};this.dialog.open(fe,{data:p}).afterClosed().subscribe(h=>{if(h.data){let T,$=this.settingsService.dateFormat,wt=this.dateUtils.formatDate(h.data.value.date,$);switch(a.chargeTimeType.value){case"Specified due date":case"Weekly Fee":T=K(B({},a),{dueDate:wt});break;case"Annual Fee":T=K(B({},a),{feeOnMonthDay:wt});break}this.chargesDataSource.splice(this.chargesDataSource.indexOf(a),1,T),this.chargesDataSource=this.chargesDataSource.concat([])}}),this.pristine=!1}editChargeFeeInterval(a){let l=[new Re({controlName:"feeInterval",label:"Fee Interval",value:a.feeInterval,type:"text",required:!1})],p={title:"Edit Charge Fee Interval",layout:{addButtonText:"Confirm"},formfields:l};this.dialog.open(fe,{data:p}).afterClosed().subscribe(h=>{if(h.data){let T=K(B({},a),{feeInterval:h.data.value.feeInterval});this.chargesDataSource.splice(this.chargesDataSource.indexOf(a),1,T),this.chargesDataSource=this.chargesDataSource.concat([])}}),this.pristine=!1}deleteCharge(a){this.dialog.open(se,{data:{deleteContext:`charge ${a.name}`}}).afterClosed().subscribe(p=>{p.delete&&(this.chargesDataSource.splice(this.chargesDataSource.indexOf(a),1),this.chargesDataSource=this.chargesDataSource.concat([]),this.pristine=!1)})}get recurringDepositAccountCharges(){return{charges:this.chargesDataSource}}static{this.\u0275fac=function(l){return new(l||e)(C(ee),C(Q),C(U))}}static{this.\u0275cmp=A({type:e,selectors:[["mifosx-recurring-deposits-account-charges-step"]],inputs:{recurringDepositsAccountTemplate:"recurringDepositsAccountTemplate",recurringDepositsAccountProductTemplate:"recurringDepositsAccountProductTemplate",currencyCode:"currencyCode",recurringDepositAccountFormValid:"recurringDepositAccountFormValid"},features:[Zt],decls:96,vars:19,consts:[["charge",""],[1,"layout-row-wrap","gap-2px","responsive-column"],[1,"flex-48"],[3,"value",4,"ngFor","ngForOf"],[1,"flex-48","align-center"],["type","button","mat-raised-button","","color","primary",3,"click","disabled"],["icon","plus",1,"m-r-10"],["mat-table","",1,"flex-98","mat-elevation-z1",3,"dataSource","hidden"],["matColumnDef","name"],["mat-header-cell","",4,"matHeaderCellDef"],["mat-cell","",4,"matCellDef"],["matColumnDef","chargeCalculationType"],["matColumnDef","amount"],["matColumnDef","chargeTimeType"],["matColumnDef","date"],["matColumnDef","repaymentsEvery"],["matColumnDef","action"],["mat-header-row","",4,"matHeaderRowDef"],["mat-row","",4,"matRowDef","matRowDefColumns"],[1,"layout-row","responsive-column","align-center","gap-2px","margin-t"],["mat-raised-button","","matStepperPrevious",""],["icon","arrow-left",1,"m-r-10"],["mat-raised-button","","matStepperNext","",3,"disabled"],["icon","arrow-right",1,"m-l-10"],[3,"value"],["mat-header-cell",""],["mat-cell",""],["mat-icon-button","","color","primary",3,"click"],["icon","pen"],[4,"ngIf"],["mat-icon-button","","color","primary",3,"click",4,"ngIf"],["mat-icon-button","","color","warn",3,"click"],["icon","trash"],["mat-header-row",""],["mat-row",""]],template:function(l,p){if(l&1){let g=y();n(0,"div",1),t(1,`
  `),n(2,"mat-form-field",2),t(3,`
    `),n(4,"mat-label"),t(5),o(6,"translate"),i(),t(7,`
    `),n(8,"mat-select",null,0),t(10,`
      `),m(11,Zr,2,2,"mat-option",3),t(12,`
    `),i(),t(13,`
  `),i(),t(14,`
...
`),n(81,"div",19),t(82,`
  ...
  `),i(),t(94,`
`),i(),t(95,`
`)}if(l&2){let g=R(9);r(5),u(c(6,11,"labels.inputs.Charge")),r(6),d("ngForOf",p.chargeData),r(6),d("disabled",!g.value),r(3),x(`
  ...
  `),i()),e&2){let a=_();r(3),x("",c(4,2,"labels.inputs.name"),":"),r(4),u(a.recurringDepositsAccountProductTemplate.accountChart.name)}}function Po(e,s){if(e&1&&(n(0,"div",3),t(1,`
    `),n(2,"span",4),t(3),o(4,"translate"),i(),t(5,`
    `),n(6,"span",5),t(7),o(8,"dateFormat"),i(),t(9,`
  `),i()),e&2){let a=_();r(3),x("",c(4,2,"labels.inputs.End Date"),":"),r(4),u(c(8,4,a.recurringDepositsAccountProductTemplate==null?null:a.recurringDepositsAccountProductTemplate.accountChart.endDate))}}function To(e,s){if(e&1&&(n(0,"div",3),t(1,`
    `),n(2,"span",4),t(3),o(4,"translate"),i(),t(5,`
    `),n(6,"span",5),t(7),i(),t(8,`
  `),i()),e&2){let a=_();r(3),x("",c(4,2,"labels.inputs.Description"),":"),r(4),u(a.recurringDepositsAccountProductTemplate==null?null:a.recurringDepositsAccountProductTemplate.accountChart.description)}}function Mo(e,s){e&1&&(n(0,"th",23),t(1),o(2,"translate"),i()),e&2&&(r(),u(c(2,1,"labels.inputs.Period")))}function yo(e,s){if(e&1&&(n(0,"td",24),t(1),o(2,"translateKey"),i()),e&2){let a=s.$implicit;r(),oe(`
        `,a.fromPeriod," - ",a.toPeriod,"\xA0",w(2,3,a.periodType.value,"catalogs"),`
      `)}}function Ao(e,s){e&1&&(n(0,"th",23),t(1),o(2,"translate"),i()),e&2&&(r(),u(c(2,1,"labels.inputs.Amount Range")))}function Io(e,s){if(e&1&&(n(0,"td",24),t(1),o(2,"formatNumber"),o(3,"formatNumber"),i()),e&2){let a=s.$implicit;r(),M(`
        `,c(2,2,a.amountRangeFrom)," - ",c(3,4,a.amountRangeTo),`
      `)}}function Oo(e,s){e&1&&(n(0,"th",23),t(1),o(2,"translate"),i()),e&2&&(r(),u(c(2,1,"labels.inputs.Interest")))}function Eo(e,s){if(e&1&&(n(0,"td",24),t(1),o(2,"formatNumber"),i()),e&2){let a=s.$implicit;r(),x("",c(2,1,a.annualInterestRate)," %")}}function Ro(e,s){e&1&&(n(0,"th",23),t(1),o(2,"translate"),i()),e&2&&(r(),u(c(2,1,"labels.inputs.Description")))}function wo(e,s){if(e&1&&(n(0,"td",24),t(1),i()),e&2){let a=s.$implicit;r(),u(a.description)}}function Fo(e,s){e&1&&(n(0,"th",23),t(1),o(2,"translate"),i()),e&2&&(r(),u(c(2,1,"labels.inputs.Actions")))}function Bo(e,s){e&1&&(n(0,"span"),t(1,`
            `),f(2,"fa-icon",27),t(3),o(4,"translate"),i()),e&2&&(r(3),x(`
            `,c(4,1,"labels.buttons.View Incentives"),`
          `))}function No(e,s){e&1&&(n(0,"span"),t(1,`
            `),f(2,"fa-icon",28),t(3),o(4,"translate"),i()),e&2&&(r(3),x(`
            `,c(4,1,"labels.buttons.Hide Incentives"),`
          `))}function ko(e,s){if(e&1){let a=y();n(0,"td",24),t(1,`
        ...
        `),i(),t(8,`
      `),i()}if(e&2){let a=s.dataIndex,l=_();r(4),d("ngIf",l.expandChartSlabIndex!==a),r(2),d("ngIf",l.expandChartSlabIndex===a)}}function Vo(e,s){e&1&&(n(0,"th",23),t(1),o(2,"translate"),i()),e&2&&(r(),u(c(2,1,"labels.inputs.Entity Type")))}function qo(e,s){if(e&1&&(n(0,"td",24),t(1),i()),e&2){let a=s.$implicit;r(),x(`
                  `,a.entityType.value,`
                `)}}function jo(e,s){e&1&&(n(0,"th",23),t(1),o(2,"translate"),i()),e&2&&(r(),u(c(2,1,"labels.inputs.Attribute Name")))}function Go(e,s){if(e&1&&(n(0,"td",24),t(1),i()),e&2){let a=s.$implicit;r(),x(`
                  `,a.attributeName.value,`
                `)}}function Uo(e,s){e&1&&(n(0,"th",23),t(1),o(2,"translate"),i()),e&2&&(r(),u(c(2,1,"labels.inputs.Condition Type")))}function Ho(e,s){if(e&1&&(n(0,"td",24),t(1),o(2,"titlecase"),i()),e&2){let a=s.$implicit;r(),x(`
                  `,c(2,1,a.conditionType.value),`
                `)}}function $o(e,s){e&1&&(n(0,"th",23),t(1),o(2,"translate"),i()),e&2&&(r(),u(c(2,1,"labels.inputs.Attribute Value")))}function zo(e,s){if(e&1&&(n(0,"td",41),t(1),i()),e&2){let a=s.$implicit;d("ngSwitch",a.attributeName),r(),x(`
                  `,a.attributeValueDesc,`
                `)}}function Lo(e,s){e&1&&(n(0,"th",23),t(1),o(2,"translate"),i()),e&2&&(r(),u(c(2,1,"labels.inputs.Incentive Type")))}function Wo(e,s){if(e&1&&(n(0,"td",24),t(1),i()),e&2){let a=s.$implicit;r(),x(`
                  `,a.incentiveType.value,`
                `)}}function Ko(e,s){e&1&&(n(0,"th",23),t(1),o(2,"translate"),i()),e&2&&(r(),u(c(2,1,"labels.inputs.Interest")))}function Qo(e,s){if(e&1&&(n(0,"td",24),t(1),o(2,"formatNumber"),i()),e&2){let a=s.$implicit;r(),x(`
                  `,c(2,1,a.amount),`
            ...
            `),i()),e&2){let a=_().$implicit,l=_();d("dataSource",a.incentives),r(44),d("matHeaderRowDef",l.incentivesDisplayedColumns),r(2),d("matRowDefColumns",l.incentivesDisplayedColumns)}}function Zo(e,s){if(e&1&&(n(0,"td",24),t(1,`
        `),n(2,"div",29),t(3,`
          `),n(4,"mat-card",30),t(5,`
...
`)),l&2&&(r(2),d("ngIf",p.recurringDepositsAccountProductTemplate==null?null:p.recurringDepositsAccountProductTemplate.accountChart.name),r(5),x("",c(8,13,"labels.inputs.Valid from Date"),":"),r(4),u(c(12,15,p.recurringDepositsAccountProductTemplate==null?null:p.recurringDepositsAccountProductTemplate.accountChart.fromDate)),r(4),d("ngIf",p.recurringDepositsAccountProductTemplate==null?null:p.recurringDepositsAccountProductTemplate.accountChart.endDate),r(2),d("ngIf",p.recurringDepositsAccountProductTemplate==null?null:p.recurringDepositsAccountProductTemplate.accountChart.description),r(5),x("",c(23,17,"labels.inputs.Primary Grouping by Amount"),":"),r(4),u(c(27,19,p.recurringDepositsAccountProductTemplate==null?null:p.recurringDepositsAccountProductTemplate.accountChart.isPrimaryGroupingByAmount)),r(4),d("dataSource",p.interestRateChartData),r(43),d("matHeaderRowDef",p.chartSlabsDisplayedColumns),r(2),d("matRowDefColumns",p.chartSlabsDisplayedColumns),r(2),d("matRowDefColumns",p.chartSlabsIncentivesDisplayedColumns),r(9),x(`
  ...
  `),r(4),x(`
    ...
    `))},dependencies:[I,F,Se,Pe,O,W,V,Rt,E,Ft,Bt,Vt,kt,qt,Nt,jt,ut,Gt,Ht,Ut,$t,Qt,ne,Yt,Ze],styles:[".margin-t[_ngcontent-%COMP%]{margin-top:2em}table[_ngcontent-%COMP%]{width:100%}table[_ngcontent-%COMP%]   tr.incentives-row[_ngcontent-%COMP%]{height:0}table[_ngcontent-%COMP%]   tr.incentives-row[_ngcontent-%COMP%] > td[_ngcontent-%COMP%]{padding:0}table[_ngcontent-%COMP%]   tr.incentives-row[_ngcontent-%COMP%]   .incentives[_ngcontent-%COMP%]{overflow:hidden}table[_ngcontent-%COMP%]   tr.incentives-row[_ngcontent-%COMP%]   .mat-card[_ngcontent-%COMP%]{border-radius:0}"],data:{animation:[Me("expandChartSlab",[re("collapsed",ae({height:"0px",minHeight:"0"})),re("expanded",ae({height:"*"})),Ae("expanded <=> collapsed",ye("225ms cubic-bezier(0.4, 0.0, 0.2, 1)"))])]}})}}return e})();var ip=()=>["../.."];function ap(e,s){if(e&1&&(n(0,"div",3),t(1,`
    `),n(2,"span",4),t(3),o(4,"translate"),i(),t(5,`
    `),n(6,"span",5),t(7),o(8,"find"),o(9,"translateKey"),i(),t(10,`
  `),i()),e&2){let a=_();r(3),x("",c(4,3,"labels.inputs.Lock-in Period"),":"),r(4),M("",a.recurringDepositAccountData.lockinPeriodFrequency,`
      `,w(9,10,G(8,5,a.recurringDepositAccountData.lockinPeriodFrequencyType,a.recurringDepositsAccountProductTemplate.lockinPeriodFrequencyTypeOptions,"id","value"),"catalogs"),"")}}function rp(e,s){if(e&1&&(n(0,"div",3),t(1,`
    `),n(2,"span",4),t(3),o(4,"translate"),i(),t(5,`
    `),n(6,"span",5),t(7),o(8,"formatNumber"),i(),t(9,`
  `),i()),e&2){let a=_();r(3),x("",c(4,2,"labels.inputs.Recurring Deposit Amount"),":"),r(4),u(c(8,4,a.recurringDepositAccountData.mandatoryRecommendedDepositAmount))}}function op(e,s){if(e&1&&(n(0,"span",5),t(1),o(2,"find"),o(3,"translateKey"),i()),e&2){let a=_(2);r(),M("",a.recurringDepositAccountData.recurringFrequency,`
        `,w(3,7,G(2,2,a.recurringDepositAccountData.recurringFrequencyType,a.recurringDepositsAccountProductTemplate.periodFrequencyTypeOptions,"id","value"),"catalogs"),"")}}function pp(e,s){if(e&1&&(D(0),t(1,`
    `),n(2,"div",3),t(3,`
    ...
    `),i(),t(21,`
  `),v()),e&2){let a=_();r(5),x("",c(6,4,"labels.inputs.Deposit Start Date"),":"),r(4),u(c(10,6,a.recurringDepositAccountData.expectedFirstDepositOnDate)),r(7),x("",c(17,8,"labels.inputs.Deposit Frequency"),":"),r(3),d("ngIf",a.recurringDepositAccountData.recurringFrequency)}}function cp(e,s){if(e&1&&(n(0,"div",3),t(1,`
    `),n(2,"span",4),t(3),o(4,"translate"),i(),t(5,`
    `),n(6,"span",5),t(7),i(),t(8,`
  `),i()),e&2){let a=_();r(3),x("",c(4,2,"labels.inputs.name"),":"),r(4),u(a.recurringDepositsAccountProductTemplate==null?null:a.recurringDepositsAccountProductTemplate.accountChart.name)}}function sp(e,s){if(e&1&&(n(0,"div",3),t(1,`
    `),n(2,"span",4),t(3),o(4,"translate"),i(),t(5,`
    `),n(6,"span",5),t(7),o(8,"dateFormat"),i(),t(9,`
  `),i()),e&2){let a=_();r(3),x("",c(4,2,"labels.inputs.End Date"),":"),r(4),u(c(8,4,a.recurringDepositsAccountProductTemplate==null?null:a.recurringDepositsAccountProductTemplate.accountChart.endDate))}}function lp(e,s){if(e&1&&(n(0,"div",3),t(1,`
    `),n(2,"span",4),t(3),o(4,"translate"),i(),t(5,`
    `),n(6,"span",5),t(7),i(),t(8,`
  `),i()),e&2){let a=_();r(3),x("",c(4,2,"labels.inputs.Description"),":"),r(4),u(a.recurringDepositsAccountProductTemplate==null?null:a.recurringDepositsAccountProductTemplate.accountChart.description)}}function mp(e,s){e&1&&(n(0,"th",27),t(1),o(2,"translate"),i()),e&2&&(r(),u(c(2,1,"labels.inputs.Period")))}function dp(e,s){if(e&1&&(n(0,"td",28),t(1),o(2,"translateKey"),i()),e&2){let a=s.$implicit;r(),oe(`
        `,a.fromPeriod," - ",a.toPeriod,"\xA0",w(2,3,a.periodType.value,"catalogs"),`
      `)}}function up(e,s){e&1&&(n(0,"th",27),t(1),o(2,"translate"),i()),e&2&&(r(),u(c(2,1,"labels.inputs.Amount Range")))}function gp(e,s){if(e&1&&(n(0,"td",28),t(1),o(2,"formatNumber"),o(3,"formatNumber"),i()),e&2){let a=s.$implicit;r(),M(`
        `,c(2,2,a.amountRangeFrom)," - ",c(3,4,a.amountRangeTo),`
      `)}}function xp(e,s){e&1&&(n(0,"th",27),t(1),o(2,"translate"),i()),e&2&&(r(),u(c(2,1,"labels.inputs.Interest")))}function fp(e,s){if(e&1&&(n(0,"td",28),t(1),o(2,"formatNumber"),i()),e&2){let a=s.$implicit;r(),x("",c(2,1,a.annualInterestRate)," %")}}function _p(e,s){e&1&&(n(0,"th",27),t(1),o(2,"translate"),i()),e&2&&(r(),u(c(2,1,"labels.inputs.Description")))}function Cp(e,s){if(e&1&&(n(0,"td",28),t(1),i()),e&2){let a=s.$implicit;r(),u(a.description)}}function hp(e,s){e&1&&(n(0,"th",27),t(1),o(2,"translate"),i()),e&2&&(r(),u(c(2,1,"labels.inputs.Actions")))}function Dp(e,s){e&1&&(n(0,"span"),t(1,`
            `),f(2,"fa-icon",30),t(3),o(4,"translate"),i()),e&2&&(r(3),x(`
            `,c(4,1,"labels.buttons.View Incentives"),`
          `))}function vp(e,s){e&1&&(n(0,"span"),t(1,`
            `),f(2,"fa-icon",31),t(3),o(4,"translate"),i()),e&2&&(r(3),x(`
            `,c(4,1,"labels.buttons.Hide Incentives"),`
          `))}function bp(e,s){if(e&1){let a=y();n(0,"td",28),t(1,`
        ...
        `),i(),t(8,`
      `),i()}if(e&2){let a=s.dataIndex,l=_();r(4),d("ngIf",l.expandChartSlabIndex!==a),r(2),d("ngIf",l.expandChartSlabIndex===a)}}function Sp(e,s){e&1&&(n(0,"th",27),t(1),o(2,"translate"),i()),e&2&&(r(),u(c(2,1,"labels.inputs.Entity Type")))}function Pp(e,s){if(e&1&&(n(0,"td",28),t(1),i()),e&2){let a=s.$implicit;r(),x(`
                  `,a.entityType.value,`
                `)}}function Tp(e,s){e&1&&(n(0,"th",27),t(1),o(2,"translate"),i()),e&2&&(r(),u(c(2,1,"labels.inputs.Attribute Name")))}function Mp(e,s){if(e&1&&(n(0,"td",28),t(1),i()),e&2){let a=s.$implicit;r(),x(`
                  `,a.attributeName.value,`
                `)}}function yp(e,s){e&1&&(n(0,"th",27),t(1),o(2,"translate"),i()),e&2&&(r(),u(c(2,1,"labels.inputs.Condition Type")))}function Ap(e,s){if(e&1&&(n(0,"td",28),t(1),o(2,"titlecase"),i()),e&2){let a=s.$implicit;r(),x(`
                  `,c(2,1,a.conditionType.value),`
                `)}}function Ip(e,s){e&1&&(n(0,"th",27),t(1),o(2,"translate"),i()),e&2&&(r(),u(c(2,1,"labels.inputs.Attribute Value")))}function Op(e,s){if(e&1&&(n(0,"td",44),t(1),i()),e&2){let a=s.$implicit;d("ngSwitch",a.attributeName),r(),x(`
                  `,a.attributeValueDesc,`
                `)}}function Ep(e,s){e&1&&(n(0,"th",27),t(1),o(2,"translate"),i()),e&2&&(r(),u(c(2,1,"labels.inputs.Incentive Type")))}function Rp(e,s){if(e&1&&(n(0,"td",28),t(1),i()),e&2){let a=s.$implicit;r(),x(`
                  `,a.incentiveType.value,`
                `)}}function wp(e,s){e&1&&(n(0,"th",27),t(1),o(2,"translate"),i()),e&2&&(r(),u(c(2,1,"labels.inputs.Interest")))}function Fp(e,s){if(e&1&&(n(0,"td",28),t(1),i()),e&2){let a=s.$implicit;r(),x(`
                  `,a.amount,`
            ...
            `),i()),e&2){let a=_().$implicit,l=_();d("dataSource",a.incentives),r(44),d("matHeaderRowDef",l.incentivesDisplayedColumns),r(2),d("matRowDefColumns",l.incentivesDisplayedColumns)}}function Vp(e,s){if(e&1&&(n(0,"td",28),t(1,`
        `),n(2,"div",32),t(3,`
          `),n(4,"mat-card",33),t(5,`
      ...
      `),i()),e&2){let a=s.$implicit,l=s.dataIndex,p=_();ve("colspan",p.chartSlabsDisplayedColumns.length),r(2),d("@expandChartSlab",l===p.expandChartSlabIndex?"expanded":"collapsed"),r(5),x(`
              `,c(8,4,"labels.heading.Incentives"),`
            `),r(3),d("ngIf",a.incentives.length)}}function qp(e,s){e&1&&f(0,"tr",45)}function jp(e,s){e&1&&f(0,"tr",46)}function Gp(e,s){e&1&&f(0,"tr",47)}function Up(e,s){e&1&&(n(0,"th",27),t(1),o(2,"translate"),i()),e&2&&(r(),u(c(2,1,"labels.inputs.name")))}function Hp(e,s){if(e&1&&(n(0,"td",28),t(1),i()),e&2){let a=s.$implicit;r(),x(`
          `,a.name+", "+a.currency.displaySymbol,`
        `)}}function $p(e,s){e&1&&(n(0,"th",27),t(1),o(2,"translate"),i()),e&2&&(r(),u(c(2,1,"labels.inputs.Type")))}function zp(e,s){if(e&1&&(n(0,"td",28),t(1),o(2,"translateKey"),i()),e&2){let a=s.$implicit;r(),x(`
          `,w(2,1,a.chargeCalculationType.value,"catalogs"),`
        `)}}function Lp(e,s){e&1&&(n(0,"th",27),t(1),o(2,"translate"),i()),e&2&&(r(),u(c(2,1,"labels.inputs.Amount")))}function Wp(e,s){if(e&1&&(n(0,"td",28),t(1),o(2,"formatNumber"),i()),e&2){let a=s.$implicit;r(),x(`
          `,c(2,1,a.amount),`
        `)}}function Kp(e,s){e&1&&(n(0,"th",27),t(1),o(2,"translate"),i()),e&2&&(r(),u(c(2,1,"labels.inputs.Date")))}function Qp(e,s){if(e&1&&(n(0,"span"),t(1),o(2,"dateFormat"),i()),e&2){let a=_().$implicit;r(),x(`
            `,c(2,1,a.dueDate)||"Unassigned",`
          `)}}function Yp(e,s){if(e&1&&(n(0,"span"),t(1),o(2,"dateFormat"),i()),e&2){let a=_().$implicit;r(),x(`
            `,c(2,1,a.feeOnMonthDay)||"Unassigned",`
          `)}}function Jp(e,s){e&1&&(n(0,"span"),t(1),o(2,"translate"),i()),e&2&&(r(),x(`
            `,c(2,1,"labels.inputs.N/A"),`
          `))}function Xp(e,s){if(e&1&&(n(0,"td",28),t(1,`
          `),m(2,Qp,3,3,"span",7),t(3,`
          `),m(4,Yp,3,3,"span",7),t(5,`
          `),m(6,Jp,3,3,"span",7),t(7,`
        `),i()),e&2){let a=s.$implicit;r(2),d("ngIf",a.chargeTimeType.value==="Specified due date"||a.chargeTimeType.value==="Weekly Fee"),r(2),d("ngIf",a.chargeTimeType.value==="Monthly Fee"||a.chargeTimeType.value==="Annual Fee"),r(2),d("ngIf",!(a.chargeTimeType.value==="Monthly Fee"||a.chargeTimeType.value==="Annual Fee"||a.chargeTimeType.value==="Specified due date"||a.chargeTimeType.value==="Weekly Fee"))}}function Zp(e,s){e&1&&(n(0,"th",27),t(1),o(2,"translate"),i()),e&2&&(r(),u(c(2,1,"labels.inputs.Repayments Every")))}function tc(e,s){if(e&1&&(n(0,"td",28),t(1),i()),e&2){let a=s.$implicit;r(),x(`
          `,a.feeInterval||"Not Provided",`
        `)}}function ec(e,s){e&1&&(n(0,"th",27),t(1),o(2,"translate"),i()),e&2&&(r(),u(c(2,1,"labels.inputs.Collected On")))}function nc(e,s){if(e&1&&(n(0,"td",28),t(1),i()),e&2){let a=s.$implicit;r(),x(`
          `,a.chargeTimeType.value,`
        `)}}function ic(e,s){e&1&&f(0,"tr",45)}function ac(e,s){e&1&&f(0,"tr",46)}function rc(e,s){if(e&1&&(n(0,"div",48),t(1,`
...
`)),l&2&&(r(3),u(c(4,58,"labels.heading.Details")),r(8),u(c(12,60,"labels.inputs.Product")),r(4),u(G(16,62,p.recurringDepositAccountData.productId,p.recurringDepositsAccountTemplate.productOptions,"id","name")),r(7),u(c(23,67,"labels.inputs.Submitted On")),r(4),u(c(27,69,p.recurringDepositAccountData.submittedOnDate)),r(7),u(c(34,71,"labels.inputs.Field Officer")),r(4),u(G(38,73,p.recurringDepositAccountData.fieldOfficerId,p.recurringDepositsAccountProductTemplate.fieldOfficerOptions,"id","displayName")),r(5),u(c(43,78,"labels.heading.Currency")),r(8),u(c(51,80,"labels.inputs.Currency")),r(4),u(p.recurringDepositsAccountProductTemplate.currency.code),r(6),u(c(61,82,"labels.inputs.Decimal Places")),r(4),u(p.recurringDepositsAccountProductTemplate.currency.decimalPlaces),r(6),u(c(71,84,"labels.inputs.Currency In Multiples Of")),r(4),u(p.recurringDepositsAccountProductTemplate.currency.inMultiplesOf),r(4),u(c(79,86,"labels.heading.Terms")),r(8),x("",c(87,88,"labels.inputs.Interest Compounding Period"),":"),r(4),u(w(92,95,G(91,90,p.recurringDepositAccountData.interestCompoundingPeriodType,p.recurringDepositsAccountProductTemplate.interestCompoundingPeriodTypeOptions,"id","value"),"catalogs")),r(8),x("",c(99,98,"labels.inputs.Interest Posting Period"),":"),r(4),u(w(104,105,G(103,100,p.recurringDepositAccountData.interestPostingPeriodType,p.recurringDepositsAccountProductTemplate.interestPostingPeriodTypeOptions,"id","value"),"catalogs")),r(8),x("",c(111,108,"labels.inputs.Interest Calculated using"),":"),r(4),u(w(116,115,G(115,110,p.recurringDepositAccountData.interestCalculationType,p.recurringDepositsAccountProductTemplate.interestCalculationTypeOptions,"id","value"),"catalogs")),r(8),x("",c(123,118,"labels.inputs.Days in Year"),":"),r(4),u(w(128,125,G(127,120,p.recurringDepositAccountData.interestCalculationDaysInYearType,p.recurringDepositsAccountProductTemplate.interestCalculationDaysInYearTypeOptions,"id","value"),"catalogs")),r(6),u(c(133,128,"labels.heading.Settings")),r(5),d("ngIf",p.recurringDepositAccountData.lockinPeriodFrequency),r(2),d("ngIf",p.recurringDepositAccountData.mandatoryRecommendedDepositAmount),r(5),x("",c(145,130,"labels.inputs.Deposit Period"),":"),r(4),M("",p.recurringDepositAccountData.depositPeriod,`
  ...
  `))},dependencies:[I,F,Se,Pe,O,L,W,V,Rt,E,Ft,$e,Bt,Vt,kt,qt,Nt,jt,ut,Gt,Ht,Ut,$t,Qt,ii,Yt,Ze],styles:["table[_ngcontent-%COMP%]{width:100%}.mat-elevation-z1[_ngcontent-%COMP%]{margin:1em 0 1.5em}h2[_ngcontent-%COMP%], h3[_ngcontent-%COMP%], h4[_ngcontent-%COMP%]{margin:0;font-weight:500}span[_ngcontent-%COMP%]{margin:.5em 0}mat-divider[_ngcontent-%COMP%]{margin:0 0 .5em}.margin-t[_ngcontent-%COMP%]{margin-top:1em}.margin-b[_ngcontent-%COMP%]{margin-bottom:.25em}.irc-table[_ngcontent-%COMP%]{width:100%}.irc-table[_ngcontent-%COMP%]   tr.incentives-row[_ngcontent-%COMP%]{height:0}.irc-table[_ngcontent-%COMP%]   tr.incentives-row[_ngcontent-%COMP%] > td[_ngcontent-%COMP%]{padding:0}.irc-table[_ngcontent-%COMP%]   tr.incentives-row[_ngcontent-%COMP%]   .incentives[_ngcontent-%COMP%]{overflow:hidden}.irc-table[_ngcontent-%COMP%]   tr.incentives-row[_ngcontent-%COMP%]   .mat-card[_ngcontent-%COMP%]{border-radius:0}"],data:{animation:[Me("expandChartSlab",[re("collapsed",ae({height:"0px",minHeight:"0"})),re("expanded",ae({height:"*"})),Ae("expanded <=> collapsed",ye("225ms cubic-bezier(0.4, 0.0, 0.2, 1)"))])]}})}}return e})();function oc(e,s){e&1&&(t(0,`
    ...
    `))}function lc(e,s){e&1&&(t(0,`
      `),f(1,"fa-icon",17),t(2,`
    `))}function mc(e,s){e&1&&(t(0),o(1,"translate")),e&2&&u(c(1,1,"labels.inputs.DETAILS"))}function dc(e,s){e&1&&(t(0),o(1,"translate")),e&2&&u(c(1,1,"labels.inputs.TERMS"))}function uc(e,s){e&1&&(t(0),o(1,"translate")),e&2&&u(c(1,1,"labels.inputs.SETTINGS"))}function gc(e,s){e&1&&(t(0),o(1,"translate")),e&2&&u(c(1,1,"labels.inputs.INTEREST RATE CHART"))}function xc(e,s){e&1&&(t(0),o(1,"translate")),e&2&&u(c(1,1,"labels.inputs.CHARGES"))}function fc(e,s){e&1&&(t(0),o(1,"translate")),e&2&&u(c(1,1,"labels.inputs.PREVIEW"))}function _c(e,s){if(e&1){let a=y();n(0,"mat-step",18),t(1,`
...
`)}l&2&&(r(15),d("stepControl",p.recurringDepositAccountDetailsForm),r(4),d("recurringDepositsAccountTemplate",p.recurringDepositsAccountTemplate),r(4),d("stepControl",p.recurringDepositAccountTermsForm),r(4),d("recurringDepositsAccountTemplate",p.recurringDepositsAccountTemplate)("recurringDepositsAccountProductTemplate",p.recurringDepositsAccountProductTemplate),r(4),d("stepControl",p.recurringDepositAccountSettingsForm),r(4),d("recurringDepositsAccountTemplate",p.recurringDepositsAccountTemplate)("recurringDepositsAccountProductTemplate",p.recurringDepositsAccountProductTemplate),r(8),d("recurringDepositsAccountTemplate",p.recurringDepositsAccountTemplate)("recurringDepositsAccountProductTemplate",p.recurringDepositsAccountProductTemplate),r(8),d("recurringDepositsAccountTemplate",p.recurringDepositsAccountTemplate)("recurringDepositsAccountProductTemplate",p.recurringDepositsAccountProductTemplate)("recurringDepositAccountFormValid",p.recurringDepositAccountFormValid),r(4),d("ngIf",p.recurringDepositAccountFormValid))},dependencies:[I,F,O,E,Xe,Ye,ut,Je,Qe,me,de,ue,Be,ge,Ne],encapsulation:2})}}return e})();var Cc=()=>["../../"];function hc(e,s){e&1&&(n(0,"mat-error"),t(1),o(2,"translate"),o(3,"translate"),n(4,"strong"),t(5),o(6,"translate"),i(),t(7,`
          `),i()),e&2&&(r(),M(`
            ...
            `),r(4),u(c(6,7,"labels.commons.required")))}var ln=(()=>{class e{constructor(a,l,p,g,h,T){this.formBuilder=a,this.recurringDepositsService=l,this.dateUtils=p,this.route=g,this.router=h,this.settingsService=T,this.minDate=new Date(2e3,0,1),this.maxDate=new Date,this.accountId=this.route.parent.snapshot.params.recurringDepositAccountId}ngOnInit(){this.maxDate=this.settingsService.businessDate,this.createActivateRecurringDepositsAccountForm()}createActivateRecurringDepositsAccountForm(){this.activateRecurringDepositsAccountForm=this.formBuilder.group({activatedOnDate:["",q.required]})}submit(){let a=this.activateRecurringDepositsAccountForm.value,l=this.settingsService.language.code,p=this.settingsService.dateFormat,g=this.activateRecurringDepositsAccountForm.value.activatedOnDate;a.activatedOnDate instanceof Date&&(a.activatedOnDate=this.dateUtils.formatDate(g,p));let h=K(B({},a),{dateFormat:p,locale:l});this.recurringDepositsService.executeRecurringDepositsAccountCommand(this.accountId,"activate",h).subscribe(()=>{this.router.navigate(["../../"],{relativeTo:this.route})})}static{this.\u0275fac=function(l){return new(l||e)(C(ot),C(N),C(Q),C(k),C(H),C(U))}}static{this.\u0275cmp=A({type:e,selectors:[["mifosx-activate-recurring-deposits-account"]],decls:39,vars:18,consts:[["activatedOnDatePicker",""],[1,"container"],[3,"ngSubmit","formGroup"],[1,"flex-100",3,"click"],["matInput","","required","","formControlName","activatedOnDate",3,"min","max","matDatepicker"],["matSuffix","",3,"for"],[4,"ngIf"],[1,"layout-row","align-center","gap-5px","responsive-column"],["type","button","mat-raised-button","",3,"routerLink"],["mat-raised-button","","color","primary",3,"disabled"]],template:function(l,p){if(l&1){let g=y();n(0,"div",1),t(1,`
  `),n(2,"mat-card"),t(3,`
  ...
  `),i(),t(37,`
`),i(),t(38,`
`)}if(l&2){let g=R(19);r(4),d("formGroup",p.activateRecurringDepositsAccountForm),r(7),u(c(12,11,"labels.inputs.Activated On Date")),r(3),d("min",p.minDate)("max",p.maxDate)("matDatepicker",g),r(2),d("for",g),r(5),d("ngIf",p.activateRecurringDepositsAccountForm.controls.activatedOnDate.hasError("required")),r(6),d("routerLink",z(17,Cc)),r(),x(`
        ...
        `)}},dependencies:[I,F,O,it,ct,Y,nt,st,at,rt,L,W,lt,gt,Z,X,mt,xt,dt,_t,Ct,ft,V,E],styles:[".container[_ngcontent-%COMP%]{max-width:37rem}"]})}}return e})();var Dc=()=>["../../"],mn=(()=>{class e{constructor(a,l,p,g){this.formBuilder=a,this.recurringDepositsService=l,this.route=p,this.router=g,this.undoCommand="undoapproval",this.undoAction=this.route.snapshot.params.name,this.undoAction==="Undo Activation"&&(this.undoCommand="undoactivate"),this.accountId=this.route.parent.snapshot.params.recurringDepositAccountId}ngOnInit(){this.createUndoApprovalRecurringDepositsAccountForm()}createUndoApprovalRecurringDepositsAccountForm(){this.undoApprovalRecurringDepositsAccountForm=this.formBuilder.group({note:[""]})}submit(){let a=B({},this.undoApprovalRecurringDepositsAccountForm.value);this.undoAction==="Undo Activation"?this.recurringDepositsService.executeRecurringDepositsAccountCommand(this.accountId,this.undoCommand,a).subscribe(()=>{this.router.navigate(["../../"],{relativeTo:this.route})}):this.recurringDepositsService.executeRecurringDepositsAccountCommand(this.accountId,"undoapproval",a).subscribe(()=>{this.router.navigate(["../../"],{relativeTo:this.route})})}static{this.\u0275fac=function(l){return new(l||e)(C(ot),C(N),C(k),C(H))}}static{this.\u0275cmp=A({type:e,selectors:[["mifosx-undo-approval-recurring-deposits-account"]],decls:32,vars:13,consts:[[1,"container"],[3,"ngSubmit","formGroup"],[1,"flex-100"],["matInput","","formControlName","note","cdkTextareaAutosize","","cdkAutosizeMinRows","2"],[1,"layout-row","align-center","gap-5px","responsive-column"],["type","button","mat-raised-button","",3,"routerLink"],["mat-raised-button","","color","warn",3,"disabled"]],template:function(l,p){l&1&&(n(0,"div",0),t(1,`
  `),n(2,"mat-card"),t(3,`
  ...
  `),i(),t(30,`
`),i(),t(31,`
`)),l&2&&(r(4),d("formGroup",p.undoApprovalRecurringDepositsAccountForm),r(7),u(c(12,6,"labels.inputs.Note")),r(9),d("routerLink",z(12,Dc)),r(),x(`
        ...
        `))},dependencies:[I,O,it,ct,Y,nt,at,rt,L,W,lt,gt,Z,X,dt,V,E,Kt],styles:[".container[_ngcontent-%COMP%]{max-width:37rem}"]})}}return e})();var vc=()=>["../../"];function bc(e,s){e&1&&(n(0,"mat-error"),t(1),o(2,"translate"),o(3,"translate"),n(4,"strong"),t(5),o(6,"translate"),i(),t(7,`
            `),i()),e&2&&(r(),M(`
              `,c(2,3,"labels.inputs.Approved On Date")," ",c(3,5,"labels.commons.is"),`
              `),r(4),u(c(6,7,"labels.commons.required")))}var dn=(()=>{class e{constructor(a,l,p,g,h,T){this.formBuilder=a,this.recurringDepositsService=l,this.dateUtils=p,this.route=g,this.router=h,this.settingsService=T,this.minDate=new Date(2e3,0,1),this.maxDate=new Date,this.accountId=this.route.parent.snapshot.params.recurringDepositAccountId}ngOnInit(){this.maxDate=this.settingsService.businessDate,this.createApproveRecurringDepositsAccountForm()}createApproveRecurringDepositsAccountForm(){this.approveRecurringDepositsAccountForm=this.formBuilder.group({approvedOnDate:["",q.required],note:[""]})}submit(){let a=this.approveRecurringDepositsAccountForm.value,l=this.settingsService.language.code,p=this.settingsService.dateFormat,g=this.approveRecurringDepositsAccountForm.value.approvedOnDate;a.approvedOnDate instanceof Date&&(a.approvedOnDate=this.dateUtils.formatDate(g,p));let h=K(B({},a),{dateFormat:p,locale:l});this.recurringDepositsService.executeRecurringDepositsAccountCommand(this.accountId,"approve",h).subscribe(()=>{this.router.navigate(["../../"],{relativeTo:this.route})})}static{this.\u0275fac=function(l){return new(l||e)(C(ot),C(N),C(Q),C(k),C(H),C(U))}}static{this.\u0275cmp=A({type:e,selectors:[["mifosx-approve-recurring-deposits-account"]],decls:51,vars:21,consts:[["approvedOnDatePicker",""],[1,"container"],[3,"ngSubmit","formGroup"],[1,"layout-column"],[3,"click"],["matInput","","required","","formControlName","approvedOnDate",3,"min","max","matDatepicker"],["matSuffix","",3,"for"],[4,"ngIf"],["matInput","","formControlName","note","cdkTextareaAutosize","","cdkAutosizeMinRows","2"],[1,"layout-row","align-center","gap-5px","responsive-column"],["type","button","mat-raised-button","",3,"routerLink"],["mat-raised-button","","color","primary",3,"disabled"]],template:function(l,p){if(l&1){let g=y();n(0,"div",1),t(1,`
  `),n(2,"mat-card"),t(3,`
    `),n(4,"form",2),b("ngSubmit",function(){return S(g),P(p.submit())}),t(5,`
      `),n(6,"mat-card-content"),t(7,`
        `),n(8,"div",3),t(9,`
  ...
  `),i(),t(49,`
`),i(),t(50,`
`)}if(l&2){let g=R(21);r(4),d("formGroup",p.approveRecurringDepositsAccountForm),r(9),u(c(14,12,"labels.inputs.Approved On Date")),r(3),d("min",p.minDate)("max",p.maxDate)("matDatepicker",g),r(2),d("for",g),r(5),d("ngIf",p.approveRecurringDepositsAccountForm.controls.approvedOnDate.hasError("required")),r(6),u(c(30,14,"labels.inputs.Note")),r(10),d("routerLink",z(20,vc)),r(),x(`
          `,c(41,16,"labels.buttons.Cancel"),`
        `),r(3),d("disabled",!p.approveRecurringDepositsAccountForm),r(),x(`
          `,c(45,18,"labels.buttons.Confirm"),`
        `)}},dependencies:[I,F,O,it,ct,Y,nt,st,at,rt,L,W,lt,gt,Z,X,mt,xt,dt,_t,Ct,ft,V,E,Kt],styles:[".container[_ngcontent-%COMP%]{max-width:37rem}"]})}}return e})();var Sc=()=>["../../"];function Pc(e,s){e&1&&(n(0,"mat-error"),t(1),o(2,"translate"),o(3,"translate"),n(4,"strong"),t(5),o(6,"translate"),i(),t(7,`
            `),i()),e&2&&(r(),M(`
              `,c(2,3,"labels.inputs.Rejected On Date")," ",c(3,5,"labels.commons.is"),`
              `),r(4),u(c(6,7,"labels.commons.required")))}var un=(()=>{class e{constructor(a,l,p,g,h,T){this.formBuilder=a,this.recurringDepositsService=l,this.dateUtils=p,this.route=g,this.router=h,this.settingsService=T,this.minDate=new Date(2e3,0,1),this.maxDate=new Date,this.accountId=this.route.parent.snapshot.params.recurringDepositAccountId}ngOnInit(){this.maxDate=this.settingsService.businessDate,this.createRejectRecurringDepositsAccountForm()}createRejectRecurringDepositsAccountForm(){this.rejectRecurringDepositsAccountForm=this.formBuilder.group({rejectedOnDate:["",q.required],note:[""]})}submit(){let a=this.rejectRecurringDepositsAccountForm.value,l=this.settingsService.language.code,p=this.settingsService.dateFormat,g=this.rejectRecurringDepositsAccountForm.value.rejectedOnDate;a.rejectedOnDate instanceof Date&&(a.rejectedOnDate=this.dateUtils.formatDate(g,p));let h=K(B({},a),{dateFormat:p,locale:l});this.recurringDepositsService.executeRecurringDepositsAccountCommand(this.accountId,"reject",h).subscribe(()=>{this.router.navigate(["../../"],{relativeTo:this.route})})}static{this.\u0275fac=function(l){return new(l||e)(C(ot),C(N),C(Q),C(k),C(H),C(U))}}static{this.\u0275cmp=A({type:e,selectors:[["mifosx-reject-recurring-deposits-account"]],decls:51,vars:21,consts:[["rejectedOnDatePicker",""],[1,"container"],[3,"ngSubmit","formGroup"],[1,"layout-column"],[3,"click"],["matInput","","required","","formControlName","rejectedOnDate",3,"min","max","matDatepicker"],["matSuffix","",3,"for"],[4,"ngIf"],["matInput","","formControlName","note","cdkTextareaAutosize","","cdkAutosizeMinRows","2"],[1,"layout-row","align-center","gap-5px","responsive-column"],["type","button","mat-raised-button","",3,"routerLink"],["mat-raised-button","","color","primary",3,"disabled"]],template:function(l,p){if(l&1){let g=y();n(0,"div",1),t(1,`
  `),n(2,"mat-card"),t(3,`
    `),n(4,"form",2),b("ngSubmit",function(){return S(g),P(p.submit())}),t(5,`
      `),n(6,"mat-card-content"),t(7,`
        `),n(8,"div",3),t(9,`
  ...
  `),i(),t(49,`
`),i(),t(50,`
`)}if(l&2){let g=R(21);r(4),d("formGroup",p.rejectRecurringDepositsAccountForm),r(9),u(c(14,12,"labels.inputs.Rejected On Date")),r(3),d("min",p.minDate)("max",p.maxDate)("matDatepicker",g),r(2),d("for",g),r(5),d("ngIf",p.rejectRecurringDepositsAccountForm.controls.rejectedOnDate.hasError("required")),r(6),u(c(30,14,"labels.inputs.Note")),r(10),d("routerLink",z(20,Sc)),r(),x(`
          `,c(41,16,"labels.buttons.Cancel"),`
        `),r(3),d("disabled",!p.rejectRecurringDepositsAccountForm),r(),x(`
          `,c(45,18,"labels.buttons.Confirm"),`
        `)}},dependencies:[I,F,O,it,ct,Y,nt,st,at,rt,L,W,lt,gt,Z,X,mt,xt,dt,_t,Ct,ft,V,E,Kt],styles:[".container[_ngcontent-%COMP%]{max-width:37rem}"]})}}return e})();var Tc=()=>["../../"];function Mc(e,s){e&1&&(n(0,"mat-error"),t(1),o(2,"translate"),o(3,"translate"),n(4,"strong"),t(5),o(6,"translate"),i(),t(7,`
            `),i()),e&2&&(r(),M(`
              `,c(2,3,"labels.inputs.Withdrawn On Date")," ",c(3,5,"labels.commons.is"),`
              `),r(4),u(c(6,7,"labels.commons.required")))}var gn=(()=>{class e{constructor(a,l,p,g,h,T){this.formBuilder=a,this.recurringDepositsService=l,this.dateUtils=p,this.route=g,this.router=h,this.settingsService=T,this.minDate=new Date(2e3,0,1),this.maxDate=new Date,this.accountId=this.route.parent.snapshot.params.recurringDepositAccountId}ngOnInit(){this.maxDate=this.settingsService.businessDate,this.createWithdrawRecurringDepositsAccountForm()}createWithdrawRecurringDepositsAccountForm(){this.withdrawRecurringDepositsAccountForm=this.formBuilder.group({withdrawnOnDate:["",q.required],note:[""]})}submit(){let a=this.withdrawRecurringDepositsAccountForm.value,l=this.settingsService.language.code,p=this.settingsService.dateFormat,g=this.withdrawRecurringDepositsAccountForm.value.withdrawnOnDate;a.withdrawnOnDate instanceof Date&&(a.withdrawnOnDate=this.dateUtils.formatDate(g,p));let h=K(B({},a),{dateFormat:p,locale:l});this.recurringDepositsService.executeRecurringDepositsAccountCommand(this.accountId,"withdrawnByApplicant",h).subscribe(()=>{this.router.navigate(["../../"],{relativeTo:this.route})})}static{this.\u0275fac=function(l){return new(l||e)(C(ot),C(N),C(Q),C(k),C(H),C(U))}}static{this.\u0275cmp=A({type:e,selectors:[["mifosx-withdraw-by-client-recurring-deposits-account"]],decls:51,vars:21,consts:[["withdrawnOnDatePicker",""],[1,"container"],[3,"ngSubmit","formGroup"],[1,"layout-column"],[3,"click"],["matInput","","required","","formControlName","withdrawnOnDate",3,"min","max","matDatepicker"],["matSuffix","",3,"for"],[4,"ngIf"],["matInput","","formControlName","note","cdkTextareaAutosize","","cdkAutosizeMinRows","2"],[1,"layout-row","align-center","gap-5px","responsive-column"],["type","button","mat-raised-button","",3,"routerLink"],["mat-raised-button","","color","primary",3,"disabled"]],template:function(l,p){if(l&1){let g=y();n(0,"div",1),t(1,`
  `),n(2,"mat-card"),t(3,`
    `),n(4,"form",2),b("ngSubmit",function(){return S(g),P(p.submit())}),t(5,`
      `),n(6,"mat-card-content"),t(7,`
        `),n(8,"div",3),t(9,`
  ...
  `),i(),t(49,`
`),i(),t(50,`
`)}if(l&2){let g=R(21);r(4),d("formGroup",p.withdrawRecurringDepositsAccountForm),r(9),u(c(14,12,"labels.inputs.Withdrawn On Date")),r(3),d("min",p.minDate)("max",p.maxDate)("matDatepicker",g),r(2),d("for",g),r(5),d("ngIf",p.withdrawRecurringDepositsAccountForm.controls.withdrawnOnDate.hasError("required")),r(6),u(c(30,14,"labels.inputs.Note")),r(10),d("routerLink",z(20,Tc)),r(),x(`
          `,c(41,16,"labels.buttons.Cancel"),`
        `),r(3),d("disabled",!p.withdrawRecurringDepositsAccountForm.valid),r(),x(`
          `,c(45,18,"labels.buttons.Confirm"),`
        `)}},dependencies:[I,F,O,it,ct,Y,nt,st,at,rt,L,W,lt,gt,Z,X,mt,xt,dt,_t,Ct,ft,V,E,Kt],styles:[".container[_ngcontent-%COMP%]{max-width:37rem}"]})}}return e})();var yc=()=>["../../"];function Ac(e,s){if(e&1&&(n(0,"mat-option",12),t(1),i()),e&2){let a=s.$implicit;d("value",a.id),r(),x(`
            ...
            `),i()),e&2&&(r(),M(`
              ...
              `),r(4),u(c(6,7,"labels.commons.required")))}function Oc(e,s){e&1&&(n(0,"mat-error"),t(1),o(2,"translate"),o(3,"translate"),n(4,"strong"),t(5),o(6,"translate"),i(),t(7,`
              `),i()),e&2&&(r(),M(`
                `,c(2,3,"labels.inputs.Amount")," ",c(3,5,"labels.commons.is"),`
                `),r(4),u(c(6,7,"labels.commons.required")))}function Ec(e,s){if(e&1&&(n(0,"mat-option",12),t(1),i()),e&2){let a=s.$implicit;d("value",a.id),r(),x(`
                  `,a.value,`
                `)}}function Rc(e,s){if(e&1&&(n(0,"mat-option",12),t(1),i()),e&2){let a=s.$implicit;d("value",a.id),r(),x(`
                  `,a.value,`
              ...
              `),i()),e&2&&(r(),M(`
                ...
                `),r(4),u(c(6,7,"labels.commons.required")))}function Fc(e,s){if(e&1){let a=y();n(0,"mat-form-field",17),b("click",function(){S(a);let p=R(11);return P(p.open())}),t(1,`
              `),n(2,"mat-label"),t(3),o(4,"translate"),i(),t(5,`
              `),f(6,"input",18),t(7,`
              `),f(8,"mat-datepicker-toggle",19),t(9,`
              `),f(10,"mat-datepicker",null,0),t(12,`
              `),m(13,wc,8,9,"mat-error",7),t(14,`
            `),i()}if(e&2){let a=R(11),l=_(2);r(3),u(c(4,6,"labels.inputs.Due for collection on")),r(3),d("min",l.minDate)("max",l.maxDate)("matDatepicker",a),r(2),d("for",a),r(5),d("ngIf",l.recurringDepositsChargeForm.controls.dueDate.hasError("required"))}}function Bc(e,s){e&1&&(n(0,"mat-error"),t(1),o(2,"translate"),o(3,"translate"),n(4,"strong"),t(5),o(6,"translate"),i(),t(7,`
              `),i()),e&2&&(r(),M(`
                `,c(2,3,"labels.inputs.Due Date")," ",c(3,5,"labels.commons.is"),`
                `),r(4),u(c(6,7,"labels.commons.required")))}function Nc(e,s){if(e&1){let a=y();n(0,"mat-form-field",17),b("click",function(){S(a);let p=R(11);return P(p.open())}),t(1,`
              `),n(2,"mat-label"),t(3),o(4,"translate"),i(),t(5,`
              `),f(6,"input",20),t(7,`
              `),f(8,"mat-datepicker-toggle",19),t(9,`
              `),f(10,"mat-datepicker",null,1),t(12,`
              `),m(13,Bc,8,9,"mat-error",7),t(14,`
            `),i()}if(e&2){let a=R(11),l=_(2);r(3),u(c(4,6,"labels.inputs.Due On")),r(3),d("min",l.minDate)("max",l.maxDate)("matDatepicker",a),r(2),d("for",a),r(5),d("ngIf",l.recurringDepositsChargeForm.controls.feeOnMonthDay.hasError("required"))}}function kc(e,s){e&1&&(n(0,"mat-form-field"),t(1,`
              `),n(2,"mat-label"),t(3),o(4,"translate"),i(),t(5,`
              `),f(6,"input",21),t(7,`
            `),i()),e&2&&(r(3),u(c(4,1,"labels.inputs.Repeats Every")))}function Vc(e,s){if(e&1&&(n(0,"div",4),t(1,`
  ...
  `),i(),t(40,`
`),i(),t(41,`
`)),l&2&&(r(4),d("formGroup",p.recurringDepositsChargeForm),r(9),u(c(14,9,"labels.inputs.Charge")),r(5),d("ngForOf",p.savingsChargeOptions),r(3),d("ngIf",p.recurringDepositsChargeForm.controls.chargeId.hasError("required")),r(3),d("ngIf",p.chargeDetails),r(5),d("routerLink",z(15,yc)),r(),x(`
            `,c(31,11,"labels.buttons.Cancel"),`
          `),r(3),d("disabled",!p.recurringDepositsChargeForm.valid),r(),x(`
            `,c(35,13,"labels.buttons.Submit"),`
          `))},dependencies:[I,Mt,F,O,it,ct,Ee,Y,nt,st,at,rt,L,W,lt,gt,Z,X,mt,xt,dt,Et,Ot,_t,Ct,ft,V,E],styles:[".container[_ngcontent-%COMP%]{width:37rem}"]})}}return e})();var qc=()=>["../../"];function jc(e,s){e&1&&(n(0,"mat-error"),t(1),o(2,"translate"),o(3,"translate"),n(4,"strong"),t(5),o(6,"translate"),i(),t(7,`
            `),i()),e&2&&(r(),M(`
              `,c(2,3,"labels.inputs.Closed On Date")," ",c(3,5,"labels.commons.is"),`
              `),r(4),u(c(6,7,"labels.commons.required")))}var fn=(()=>{class e{constructor(a,l,p,g,h,T){this.formBuilder=a,this.recurringDepositsService=l,this.dateUtils=p,this.route=g,this.router=h,this.settingsService=T,this.minDate=new Date(2e3,0,1),this.maxDate=new Date,this.accountId=this.route.parent.snapshot.params.recurringDepositAccountId}ngOnInit(){this.maxDate=this.settingsService.businessDate,this.createprematureCloseRecurringDepositsAccountForm()}createprematureCloseRecurringDepositsAccountForm(){this.prematureCloseRecurringDepositsAccountForm=this.formBuilder.group({closedOnDate:["",q.required]})}submit(){let a=this.prematureCloseRecurringDepositsAccountForm.value,l=this.settingsService.language.code,p=this.settingsService.dateFormat,g=this.prematureCloseRecurringDepositsAccountForm.value.closedOnDate;a.closedOnDate instanceof Date&&(a.closedOnDate=this.dateUtils.formatDate(g,p));let h=K(B({},a),{dateFormat:p,locale:l});this.recurringDepositsService.executeRecurringDepositsAccountCommand(this.accountId,"prematureClose",h).subscribe(()=>{this.router.navigate(["../../"],{relativeTo:this.route})})}static{this.\u0275fac=function(l){return new(l||e)(C(ot),C(N),C(Q),C(k),C(H),C(U))}}static{this.\u0275cmp=A({type:e,selectors:[["mifosx-premature-close-recurring-deposit-account"]],decls:42,vars:18,consts:[["closedOnDatePicker",""],[1,"container"],[3,"ngSubmit","formGroup"],[1,"layout-column"],[3,"click"],["matInput","","required","","formControlName","closedOnDate",3,"min","max","matDatepicker"],["matSuffix","",3,"for"],[4,"ngIf"],[1,"layout-row","align-center","gap-5px","responsive-column"],["type","button","mat-raised-button","",3,"routerLink"],["mat-raised-button","","color","primary",3,"disabled"]],template:function(l,p){if(l&1){let g=y();n(0,"div",1),t(1,`
  `),n(2,"mat-card"),t(3,`
    `),n(4,"form",2),b("ngSubmit",function(){return S(g),P(p.submit())}),t(5,`
      `),n(6,"mat-card-content"),t(7,`
        `),n(8,"div",3),t(9,`
  ...
  `),i(),t(40,`
`),i(),t(41,`
`)}if(l&2){let g=R(21);r(4),d("formGroup",p.prematureCloseRecurringDepositsAccountForm),r(9),u(c(14,11,"labels.inputs.Closed On")),r(3),d("min",p.minDate)("max",p.maxDate)("matDatepicker",g),r(2),d("for",g),r(5),d("ngIf",p.prematureCloseRecurringDepositsAccountForm.controls.closedOnDate.hasError("required")),r(7),d("routerLink",z(17,qc)),r(),x(`
        ...
        `)}},dependencies:[I,F,O,it,ct,Y,nt,st,at,rt,L,W,lt,gt,Z,X,mt,xt,dt,_t,Ct,ft,V,E],styles:[".container[_ngcontent-%COMP%]{max-width:37rem}"]})}}return e})();var Gc=()=>["../general"];function Uc(e,s){e&1&&(n(0,"mat-error"),t(1),o(2,"translate"),o(3,"translate"),n(4,"strong"),t(5),o(6,"translate"),i(),t(7,`
            `),i()),e&2&&(r(),M(`
              `,c(2,3,"labels.inputs.Closed On")," ",c(3,5,"labels.commons.is"),`
              `),r(4),u(c(6,7,"labels.commons.required")))}function Hc(e,s){e&1&&(n(0,"mat-error"),t(1),o(2,"translate"),o(3,"translate"),n(4,"strong"),t(5),o(6,"translate"),i(),t(7,`
            `),i()),e&2&&(r(),M(`
              `,c(2,3,"labels.inputs.Maturity Amount")," ",c(3,5,"labels.commons.is"),`
              `),r(4),u(c(6,7,"labels.commons.required")))}function $c(e,s){if(e&1&&(n(0,"mat-option",21),t(1),i()),e&2){let a=s.$implicit;d("value",a.id),r(),x(`
                `,a.value,`
            ...
            `),i()),e&2&&(r(),M(`
              ...
              `),r(4),u(c(6,7,"labels.commons.required")))}function Lc(e,s){if(e&1&&(n(0,"mat-option",21),t(1),i()),e&2){let a=s.$implicit;d("value",a.id),r(),x(`
                `,a.accountNo,`
              `)}}function Wc(e,s){e&1&&(n(0,"mat-error"),t(1),o(2,"translate"),o(3,"translate"),n(4,"strong"),t(5),o(6,"translate"),i(),t(7,`
            `),i()),e&2&&(r(),M(`
              `,c(2,3,"labels.inputs.Transfer to savings account")," ",c(3,5,"labels.commons.is"),`
              `),r(4),u(c(6,7,"labels.commons.required")))}function Kc(e,s){if(e&1&&(n(0,"mat-form-field"),t(1,`
            `),n(2,"mat-label"),t(3),o(4,"translate"),i(),t(5,`
            `),n(6,"mat-select",22),t(7,`
              `),m(8,Lc,2,2,"mat-option",11),t(9,`
            `),i(),t(10,`
            `),m(11,Wc,8,9,"mat-error",8),t(12,`
          `),i()),e&2){let a=_();r(3),u(c(4,3,"labels.inputs.Transfer to Savings")),r(5),d("ngForOf",a.savingsAccountsData),r(3),d("ngIf",a.closeRecurringDepositForm.controls.toSavingsAccountId.hasError("required"))}}function Qc(e,s){e&1&&(n(0,"mat-form-field"),t(1,`
            `),n(2,"mat-label"),t(3),o(4,"translate"),i(),t(5,`
            `),f(6,"input",23),t(7,`
          `),i()),e&2&&(r(3),u(c(4,1,"labels.inputs.Transfer Description")))}function Yc(e,s){if(e&1&&(n(0,"mat-option",21),t(1),i()),e&2){let a=s.$implicit;d("value",a.id),r(),x(`
                `,a.name,`
            ...
            `),i()),e&2&&(r(),M(`
              ...
              `),r(4),u(c(6,7,"labels.commons.required")))}function Xc(e,s){e&1&&(n(0,"button",24),t(1,`
                `),f(2,"i",25),t(3,`
  ...
  `),i(),t(111,`
`),i(),t(112,`
`)}if(l&2){let g=R(24);r(4),d("formGroup",p.closeRecurringDepositForm),r(7),u(p.title),r(5),u(c(17,27,"labels.inputs.Closed On")),r(3),d("min",p.minDate)("max",p.maxDate)("matDatepicker",g),r(2),d("for",g),r(5),d("ngIf",p.closeRecurringDepositForm.controls.closedOnDate.hasError("required")),r(6),u(c(33,29,"labels.inputs.Maturity Amount")),r(5),d("ngIf",p.closeRecurringDepositForm.controls.maturityAmount.hasError("required")),r(6),u(c(44,31,"labels.inputs.Action")),r(5),d("ngForOf",p.onAccountClosureOptions),r(3),d("ngIf",p.closeRecurringDepositForm.controls.onAccountClosureId.hasError("required")),r(3),d("ngIf",p.closeRecurringDepositForm.contains("toSavingsAccountId")),r(2),d("ngIf",p.closeRecurringDepositForm.contains("transferDescription")),r(5),u(c(62,33,"labels.inputs.Payment Type Id")),r(5),d("ngForOf",p.paymentTypes),r(3),d("ngIf",p.closeRecurringDepositForm.controls.paymentTypeId.hasError("required")),r(6),x(" ",c(76,35,"labels.inputs.Show Payment Details"),""),r(5),d("ngIf",p.showPaymentDetails),r(2),d("ngIf",!p.showPaymentDetails),r(4),d("ngIf",p.showPaymentDetails),r(5),u(c(92,37,"labels.inputs.Note")),r(10),d("routerLink",z(43,Gc)),r(),x(`
          `,c(103,39,"labels.buttons.Cancel"),`
        `),r(3),d("disabled",!p.closeRecurringDepositForm.valid),r(),x(`
          `,c(107,41,"labels.buttons.Submit"),`
        `)}},dependencies:[I,Mt,F,O,it,ct,Y,nt,st,at,rt,L,W,lt,gt,Z,X,mt,xt,dt,Et,Ot,_t,Ct,ft,V,E,Kt],styles:[".container[_ngcontent-%COMP%]{max-width:37rem}.expandcollapsebutton[_ngcontent-%COMP%]{margin-top:-7px;margin-left:2%}"]})}}return e})();var e0=()=>["../../general"];function n0(e,s){if(e&1&&(n(0,"h2",20),t(1),o(2,"translate"),o(3,"translate"),i()),e&2){let a=_();r(),M(`
    ...
    `)}}function i0(e,s){e&1&&(n(0,"mat-error"),t(1),o(2,"translate"),o(3,"translate"),n(4,"strong"),t(5),o(6,"translate"),i(),t(7,`
            `),i()),e&2&&(r(),M(`
              ...
              `),r(4),u(c(6,7,"labels.commons.required")))}function a0(e,s){if(e&1&&(n(0,"mat-option",21),t(1),i()),e&2){let a=s.$implicit;d("value",a.id),r(),x(`
                `,a.name,`
              `)}}function r0(e,s){e&1&&(n(0,"mat-error"),t(1),o(2,"translate"),o(3,"translate"),n(4,"strong"),t(5),o(6,"translate"),i(),t(7,`
            `),i()),e&2&&(r(),M(`
              `,c(2,3,"labels.inputs.Payment Type")," ",c(3,5,"labels.commons.is"),`
              `),r(4),u(c(6,7,"labels.commons.required")))}function o0(e,s){e&1&&(D(0),t(1,`
            `),n(2,"mat-form-field"),t(3,`
              `),n(4,"mat-label"),t(5),o(6,"translate"),i(),t(7,`
              `),f(8,"input",22),t(9,`
            `),i(),t(10,`
  ...
  `),i(),t(86,`
`),i(),t(87,`
`)}if(l&2){let g=R(23);r(4),d("ngIf",p.transactionType.withdrawal),r(2),d("formGroup",p.depositRecurringDepositForm),r(9),u(c(16,23,"labels.inputs.Transaction Date")),r(3),d("min",p.minDate)("max",p.maxDate)("matDatepicker",g),r(2),d("for",g),r(5),d("ngIf",p.depositRecurringDepositForm.controls.transactionDate.hasError("required")),r(3),d("currency",p.currency)("isRequired",!0)("inputFormControl",p.depositRecurringDepositForm.controls.transactionAmount)("inputLabel","Transaction Amount"),r(6),u(c(35,25,"labels.inputs.Payment Type Id")),r(5),d("ngForOf",p.paymentTypes),r(3),d("ngIf",p.depositRecurringDepositForm.controls.paymentTypeId.hasError("required")),r(9),d("className",p.showPaymentDetails?"enabled":"disabled"),r(3),u(c(55,27,"labels.inputs.Show Payment Details")),r(7),d("ngIf",p.showPaymentDetails),r(5),u(c(67,29,"labels.inputs.Note")),r(10),d("routerLink",z(35,e0)),r(),x(`
          `,c(78,31,"labels.buttons.Cancel"),`
        `),r(3),d("disabled",!p.depositRecurringDepositForm.valid),r(),x(`
          `,c(82,33,"labels.buttons.Submit"),`
        `)}},dependencies:[I,Mt,F,O,it,ct,Y,nt,st,at,rt,L,W,lt,gt,Z,X,mt,xt,dt,Et,Ot,_t,Ct,ft,V,E,we,Ke,Kt],styles:[".container[_ngcontent-%COMP%]{max-width:37rem}.expandcollapsebutton[_ngcontent-%COMP%]{margin-top:-7px;margin-left:2%}.right-input[_ngcontent-%COMP%]{text-align:right}.right-label[_ngcontent-%COMP%]{padding-right:25px!important}"]})}}return e})();function p0(e,s){e&1&&f(0,"mifosx-activate-recurring-deposits-account")}function c0(e,s){e&1&&f(0,"mifosx-undo-approval-recurring-deposits-account")}function s0(e,s){e&1&&f(0,"mifosx-approve-recurring-deposits-account")}function l0(e,s){e&1&&f(0,"mifosx-reject-recurring-deposits-account")}function m0(e,s){e&1&&f(0,"mifosx-withdraw-by-client-recurring-deposits-account")}function d0(e,s){e&1&&f(0,"mifosx-add-charge-recurring-deposits-account")}function u0(e,s){e&1&&f(0,"mifosx-premature-close-recurring-deposit-account")}function g0(e,s){e&1&&f(0,"mifosx-close-recurring-deposits-account")}function x0(e,s){if(e&1&&f(0,"mifosx-deposit-recurring-deposits-account",2),e&2){let a=_();d("currency",a.currency)}}var hn=(()=>{class e{constructor(a){this.route=a,this.actions={Activate:!1,"Undo Activation":!1,"Undo Approval":!1,Approve:!1,Reject:!1,"Withdrawn by Client":!1,"Add Charge":!1,"Premature Close":!1,Close:!1,Deposit:!1,Withdrawal:!1},this.route.data.subscribe(p=>{p.recurringDepositsAccountActionData&&(this.currency=p.recurringDepositsAccountActionData.currency)});let l=this.route.snapshot.params.name;l&&l in this.actions&&(this.actions[l]=!0)}static{this.\u0275fac=function(l){return new(l||e)(C(k))}}static{this.\u0275cmp=A({type:e,selectors:[["mifosx-recurring-deposits-account-actions"]],decls:18,vars:9,consts:[[4,"ngIf"],[3,"currency",4,"ngIf"],[3,"currency"]],template:function(l,p){l&1&&(m(0,p0,1,0,"mifosx-activate-recurring-deposits-account",0),t(1,`
...
`)),l&2&&(d("ngIf",p.actions.Activate),r(2),d("ngIf",p.actions["Undo Approval"]||p.actions["Undo Activation"]),r(2),d("ngIf",p.actions.Approve),r(2),d("ngIf",p.actions.Reject),r(2),d("ngIf",p.actions["Withdrawn by Client"]),r(2),d("ngIf",p.actions["Add Charge"]),r(2),d("ngIf",p.actions["Premature Close"]),r(2),d("ngIf",p.actions.Close),r(2),d("ngIf",p.actions.Deposit||p.actions.Withdrawal))},dependencies:[I,F,O,ln,mn,dn,un,gn,xn,fn,_n,Cn],encapsulation:2})}}return e})();function f0(e,s){e&1&&(n(0,"button",15),t(1,`
  ...
  `),i()),e&2){let a=_(2);r(2),d("ngIf",!(a.transactionData.transactionType.value==="Transfer"||a.transactionData.reversed==="true"))}}function C0(e,s){if(e&1){let a=y();n(0,"button",17),b("click",function(){S(a);let p=_(2);return P(p.undoTransaction())}),t(1,`
...
`)),l&2&&(d("ngIf",!p.transactionData.reversed),r(10),d("ngClass",p.transactionColor()),r(3),x(`
  ...
  `),i(),t(78,`
`),i(),t(79,`
`)}if(l&2){let g=R(19);r(4),d("formGroup",p.editTransactionForm),r(7),u(c(12,24,"labels.inputs.Transaction Date")),r(3),d("min",p.minDate)("max",p.maxDate)("matDatepicker",g),r(2),d("for",g),r(5),d("ngIf",p.editTransactionForm.controls.transactionDate.hasError("required")),r(3),d("currency",p.currency)("isRequired",!0)("inputFormControl",p.editTransactionForm.controls.transactionAmount)("inputLabel","Transaction Amount"),r(6),u(c(31,26,"labels.inputs.Payment Type")),r(5),d("ngForOf",p.paymentTypeOptions),r(10),d("className",p.addPaymentDetailsFlag?"enabled":"disabled"),r(3),u(c(49,28,"labels.inputs.Show Payment Details")),r(7),d("ngIf",p.editTransactionForm.controls.accountNumber),r(2),d("ngIf",p.editTransactionForm.controls.checkNumber),r(2),d("ngIf",p.editTransactionForm.controls.routingCode),r(2),d("ngIf",p.editTransactionForm.controls.receiptNumber),r(2),d("ngIf",p.editTransactionForm.controls.bankNumber),r(4),d("routerLink",z(34,S0)),r(),x(`
            `,c(69,30,"labels.buttons.Cancel"),`
          `),r(3),d("disabled",!p.editTransactionForm.valid),r(),x(`
            `,c(73,32,"labels.buttons.Submit"),`
          `)}},dependencies:[I,Mt,F,O,it,ct,Ee,Y,nt,st,at,rt,L,W,lt,gt,Z,X,mt,xt,dt,Et,Ot,_t,Ct,ft,V,E,we,Ke],styles:[".container[_ngcontent-%COMP%]{width:37rem}"]})}}return e})();var di=(()=>{class e{constructor(a){this.recurringDepositsService=a}resolve(a){let l=a.paramMap.get("recurringDepositAccountId");return this.recurringDepositsService.getRecurringDepositsAccountData(l)}static{this.\u0275fac=function(l){return new(l||e)(yt(N))}}static{this.\u0275prov=It({token:e,factory:e.\u0275fac})}}return e})();var In=(()=>{class e{constructor(a){this.recurringDepositsService=a}resolve(a){let l=a.parent.paramMap.get("recurringDepositAccountId");return this.recurringDepositsService.getRecurringDepositsAccountData(l)}static{this.\u0275fac=function(l){return new(l||e)(yt(N))}}static{this.\u0275prov=It({token:e,factory:e.\u0275fac})}}return e})();var On=(()=>{class e{constructor(a){this.recurringDepositsService=a}resolve(a){let l=a.parent.parent.paramMap.get("clientId");return this.recurringDepositsService.getRecurringDepositsAccountTemplate(l)}static{this.\u0275fac=function(l){return new(l||e)(yt(N))}}static{this.\u0275prov=It({token:e,factory:e.\u0275fac})}}return e})();var En=(()=>{class e{constructor(a,l){this.savingsService=a,this.recurringDepositsService=l}resolve(a){let l=a.paramMap.get("name"),p=a.paramMap.get("recurringDepositAccountId")||a.parent.parent.paramMap.get("recurringDepositAccountId");switch(l){case"Add Charge":return this.savingsService.getSavingsChargeTemplateResource(p);case"Close":return this.recurringDepositsService.getRecurringDepositAccountActionResource(p,"close");case"Deposit":case"Withdrawal":return this.recurringDepositsService.getRecurringDepositAccountTransactionTemplateResource(p,l.toLocaleLowerCase());default:return}}static{this.\u0275fac=function(l){return new(l||e)(yt(le),yt(N))}}static{this.\u0275prov=It({token:e,factory:e.\u0275fac})}}return e})();function E0(e,s){e&1&&(t(0,`
      `),f(1,"fa-icon",15),t(2,`
    ...
    `))}function B0(e,s){e&1&&(t(0,`
      `),f(1,"fa-icon",18),t(2,`
    `))}function N0(e,s){e&1&&(t(0),o(1,"translate")),e&2&&u(c(1,1,"labels.inputs.DETAILS"))}function k0(e,s){e&1&&(t(0),o(1,"translate")),e&2&&u(c(1,1,"labels.inputs.TERMS"))}function V0(e,s){e&1&&(t(0),o(1,"translate")),e&2&&u(c(1,1,"labels.inputs.SETTINGS"))}function q0(e,s){e&1&&(t(0),o(1,"translate")),e&2&&u(c(1,1,"labels.inputs.INTEREST RATE CHART"))}function j0(e,s){e&1&&(t(0),o(1,"translate")),e&2&&u(c(1,1,"labels.inputs.CHARGES"))}function G0(e,s){e&1&&(t(0),o(1,"translate")),e&2&&u(c(1,1,"labels.inputs.PREVIEW"))}function U0(e,s){if(e&1){let a=y();n(0,"mat-step",19),t(1,`
  ...
  `),i(),t(57,`
`),i(),t(58,`
`)}l&2&&(r(15),d("stepControl",p.recurringDepositAccountDetailsForm),r(4),d("recurringDepositsAccountTemplate",p.recurringDepositsAccountAndTemplate),r(4),d("stepControl",p.recurringDepositAccountTermsForm),r(4),d("recurringDepositsAccountTemplate",p.recurringDepositsAccountAndTemplate)("recurringDepositsAccountProductTemplate",p.recurringDepositsAccountProductTemplate),r(4),d("stepControl",p.recurringDepositAccountSettingsForm),r(4),d("isNew",!1)("recurringDepositsAccountTemplate",p.recurringDepositsAccountAndTemplate)("recurringDepositsAccountProductTemplate",p.recurringDepositsAccountProductTemplate),r(8),d("recurringDepositsAccountTemplate",p.recurringDepositsAccountAndTemplate)("recurringDepositsAccountProductTemplate",p.recurringDepositsAccountProductTemplate),r(8),d("recurringDepositsAccountTemplate",p.recurringDepositsAccountAndTemplate)("recurringDepositsAccountProductTemplate",p.recurringDepositsAccountProductTemplate)("recurringDepositAccountFormValid",p.recurringDepositAccountFormValidAndNotPristine),r(4),d("ngIf",p.recurringDepositAccountFormValidAndNotPristine))},dependencies:[I,F,O,E,Xe,Ye,ut,Je,Qe,me,de,ue,Be,ge,Ne],encapsulation:2})}}return e})();var Rn=(()=>{class e{constructor(a){this.recurringDepositsService=a}resolve(a){let l=a.paramMap.get("recurringDepositAccountId");return this.recurringDepositsService.getRecurringDepositsAccountAndTemplate(l)}static{this.\u0275fac=function(l){return new(l||e)(yt(N))}}static{this.\u0275prov=It({token:e,factory:e.\u0275fac})}}return e})();var wn=(()=>{class e{constructor(a){this.recurringDepositsService=a}resolve(a){let l=a.parent.paramMap.get("recurringDepositAccountId"),p=a.paramMap.get("id");return this.recurringDepositsService.getRecurringDepositsAccountTransaction(l,p)}static{this.\u0275fac=function(l){return new(l||e)(yt(N))}}static{this.\u0275prov=It({token:e,factory:e.\u0275fac})}}return e})();var Fn=(()=>{class e{constructor(a){this.recurringDepositsService=a}resolve(a){let l=a.parent.paramMap.get("recurringDepositAccountId"),p=a.paramMap.get("id");return this.recurringDepositsService.getRecurringDepositsAccountTransactionTemplate(l,p)}static{this.\u0275fac=function(l){return new(l||e)(yt(N))}}static{this.\u0275prov=It({token:e,factory:e.\u0275fac})}}return e})();function H0(e,s){if(e&1&&(n(0,"span"),t(1,`
              `),f(2,"mifosx-external-identifier",6),t(3,`
            `),i()),e&2){let a=_(2);r(2),bt("externalId",a.recurringDepositsAccountData.externalId)}}function $0(e,s){e&1&&(n(0,"span"),t(1),o(2,"translate"),i()),e&2&&(r(),x(`
              `,c(2,1,"labels.inputs.Not Available"),`
            `))}function z0(e,s){e&1&&(n(0,"span"),t(1),o(2,"translate"),i()),e&2&&(r(),u(c(2,1,"labels.inputs.Unassigned")))}function L0(e,s){e&1&&(n(0,"td"),t(1),o(2,"translate"),i()),e&2&&(r(),x(`
          ...
          `),i(),t(10,`
        `),i()),e&2){let a=_(2);r(2),d("ngIf",a.recurringDepositsAccountData.timeline.closedOnDate),r(5),u(c(8,2,a.recurringDepositsAccountData.timeline.closedOnDate))}}function K0(e,s){if(e&1&&(n(0,"tr"),t(1,`
          `),n(2,"td"),t(3),o(4,"translate"),i(),t(5,`
          `),n(6,"td"),t(7,`
            `),n(8,"span"),t(9),i(),t(10,`
          `),i(),t(11,`
        `),i()),e&2){let a=_(2);r(3),u(c(4,2,"labels.inputs.Balance Required for Interest Calculation")),r(6),u(a.recurringDepositsAccountData.minBalanceForInterestCalculation)}}function Q0(e,s){if(e&1&&(n(0,"tr"),t(1,`
          `),n(2,"td"),t(3),o(4,"translate"),i(),t(5,`
          `),n(6,"td"),t(7,`
            `),n(8,"span"),t(9),i(),t(10,`
          `),i(),t(11,`
        `),i()),e&2){let a=_(2);r(3),u(c(4,2,"labels.inputs.Witdhold Tax Group")),r(6),u(a.recurringDepositsAccountData.taxGroup.name)}}function Y0(e,s){if(e&1&&(n(0,"div",2),t(1,`
  ...
  `),i()),e&2){let a=_();r(3),u(c(4,17,"labels.inputs.Account Details")),r(10),u(c(14,19,"labels.inputs.External Id")),r(5),d("ngIf",a.recurringDepositsAccountData.externalId),r(2),d("ngIf",!a.recurringDepositsAccountData.externalId),r(7),u(c(28,21,"labels.inputs.Field Officer")),r(4),x(`
            ...
            `,w(76,33,a.recurringDepositsAccountData.recurringFrequencyType.value,"catalogs"),`
          `),r(4),d("ngIf",a.recurringDepositsAccountData.minBalanceForInterestCalculation),r(2),d("ngIf",a.recurringDepositsAccountData.witdHoldTax)}}function J0(e,s){if(e&1&&(n(0,"span"),t(1),o(2,"currency"),i()),e&2){let a=_(2);r(),u(G(2,1,a.recurringDepositsAccountData.summary.totalDeposits,a.currency.code,"symbol-narrow","1.2-2"))}}function X0(e,s){if(e&1&&(n(0,"span"),t(1),o(2,"currency"),i()),e&2){let a=_(2);r(),u(G(2,1,0,a.currency.code,"symbol-narrow","1.2-2"))}}function Z0(e,s){if(e&1&&(n(0,"span"),t(1),o(2,"currency"),i()),e&2){let a=_(2);r(),u(G(2,1,a.recurringDepositsAccountData.summary.totalWithdrawals,a.currency.code,"symbol-narrow","1.2-2"))}}function ts(e,s){if(e&1&&(n(0,"span"),t(1),o(2,"currency"),i()),e&2){let a=_(2);r(),u(G(2,1,0,a.currency.code,"symbol-narrow","1.2-2"))}}function es(e,s){if(e&1&&(n(0,"tr"),t(1,`
          `),n(2,"td"),t(3),o(4,"translate"),i(),t(5,`
          `),n(6,"td",7),t(7,`
            `),n(8,"span"),t(9),o(10,"currency"),i(),t(11,`
          `),i(),t(12,`
        `),i()),e&2){let a=_(2);r(3),u(c(4,2,"labels.inputs.Interest Earned")),r(6),u(G(10,4,a.recurringDepositsAccountData.summary.totalInterestEarned,a.currency.code,"symbol-narrow","1.2-2"))}}function ns(e,s){if(e&1&&(n(0,"div",2),t(1,`
    `),n(2,"h4",3),t(3),o(4,"translate"),i(),t(5,`
    `),n(6,"table"),t(7,`
      `),n(8,"tbody"),t(9,`
        `),n(10,"tr"),t(11,`
      ...
      `),i(),t(82,`
    `),i(),t(83,`
  `),i()),e&2){let a=_();r(3),u(c(4,14,"labels.heading.Performance History")),r(10),u(c(14,16,"labels.inputs.Principal Amount")),r(6),u(G(20,18,a.recurringDepositsAccountData.depositAmount,a.currency.code,"symbol-narrow","1.2-2")),r(8),u(c(28,23,"labels.inputs.Maturity Amount")),r(6),u(G(34,25,a.recurringDepositsAccountData.maturityAmount,a.currency.code,"symbol-narrow","1.2-2")),r(8),u(c(42,30,"labels.inputs.Recurring Deposit Amount")),r(6),u(G(48,32,a.recurringDepositsAccountData==null?null:a.recurringDepositsAccountData.mandatoryRecommendedDepositAmount,a.currency.code,"symbol-narrow","1.2-2")),r(8),u(c(56,37,"labels.inputs.Deposits till Date")),r(5),d("ngIf",a.recurringDepositsAccountData.summary.totalDeposits),r(2),d("ngIf",!a.recurringDepositsAccountData.summary.totalDeposits),r(7),u(c(70,39,"labels.inputs.Withdrwals till Date")),r(5),d("ngIf",a.recurringDepositsAccountData.summary.totalWithdrawals),r(2),d("ngIf",!a.recurringDepositsAccountData.summary.totalWithdrawals),r(4),d("ngIf",a.recurringDepositsAccountData.summary.totalInterestEarned>=0)}}function is(e,s){if(e&1&&(n(0,"span"),t(1,`
              `),f(2,"mifosx-external-identifier",6),t(3,`
            `),i()),e&2){let a=_(2);r(2),bt("externalId",a.recurringDepositsAccountData.externalId)}}function as(e,s){e&1&&(n(0,"span"),t(1),o(2,"translate"),i()),e&2&&(r(),x(`
              `,c(2,1,"labels.inputs.Not Available"),`
            `))}function rs(e,s){e&1&&(n(0,"span"),t(1),o(2,"translate"),i()),e&2&&(r(),u(c(2,1,"labels.inputs.Not Activated")))}function os(e,s){if(e&1&&(n(0,"span"),t(1),o(2,"dateFormat"),m(3,rs,3,3,"span",4),t(4,`
            `),i()),e&2){let a=_(2);r(),x("",c(2,2,a.recurringDepositsAccountData.timeline.activatedOnDate),`
              `),r(2),d("ngIf",!a.recurringDepositsAccountData.timeline.activatedOnDate)}}function ps(e,s){e&1&&(n(0,"span"),t(1),o(2,"translate"),i()),e&2&&(r(),u(c(2,1,"labels.inputs.Not Activated")))}function cs(e,s){if(e&1&&(n(0,"span"),t(1),o(2,"dateFormat"),m(3,ps,3,3,"span",4),t(4,`
            `),i()),e&2){let a=_(2);r(),x("",c(2,2,a.recurringDepositsAccountData.expectedFirstDepositOnDate),`
              `),r(2),d("ngIf",!a.recurringDepositsAccountData.expectedFirstDepositOnDate)}}function ss(e,s){if(e&1&&(n(0,"tr"),t(1,`
          `),n(2,"td"),t(3),o(4,"translate"),i(),t(5,`
          `),n(6,"td"),t(7,`
            `),n(8,"span"),t(9),o(10,"dateFormat"),i(),t(11,`
          `),i(),t(12,`
        `),i()),e&2){let a=_(2);r(3),u(c(4,2,"labels.inputs.Maturity Date")),r(6),u(c(10,4,a.recurringDepositsAccountData.maturityDate))}}function ls(e,s){if(e&1&&(n(0,"span"),t(1),o(2,"currency"),i()),e&2){let a=_(2);r(),u(G(2,1,a.recurringDepositsAccountData.summary.totalDeposits,a.currency.code,"symbol-narrow","1.2-2"))}}function ms(e,s){if(e&1&&(n(0,"span"),t(1),o(2,"currency"),i()),e&2){let a=_(2);r(),u(G(2,1,0,a.currency.code,"symbol-narrow","1.2-2"))}}function ds(e,s){if(e&1&&(n(0,"tr"),t(1,`
          `),n(2,"td"),t(3),o(4,"translate"),i(),t(5,`
          `),n(6,"td"),t(7,`
            `),n(8,"span"),t(9),i(),t(10,`
          `),i(),t(11,`
        `),i()),e&2){let a=_(2);r(3),u(c(4,3,"labels.inputs.Interests Earned")),r(6),M("",a.recurringDepositsAccountData.currency.displaySymbol,"\xA0",a.recurringDepositsAccountData.summary.totalInterestEarned,"")}}function us(e,s){if(e&1&&(n(0,"tr"),t(1,`
          `),n(2,"td"),t(3),o(4,"translate"),i(),t(5,`
          `),n(6,"td",7),t(7,`
            `),n(8,"span"),t(9),o(10,"currency"),i(),t(11,`
          `),i(),t(12,`
        `),i()),e&2){let a=_(2);r(3),u(c(4,2,"labels.inputs.Total Withdrawls")),r(6),u(G(10,4,a.recurringDepositsAccountData.summary.totalWithdrawals,a.currency.code,"symbol-narrow","1.2-2"))}}function gs(e,s){if(e&1&&(n(0,"tr"),t(1,`
          `),n(2,"td"),t(3),o(4,"translate"),i(),t(5,`
          `),n(6,"td",7),t(7,`
            `),n(8,"span"),t(9),o(10,"number"),i(),t(11,`
          `),i(),t(12,`
        `),i()),e&2){let a=_(2);r(3),u(c(4,2,"labels.inputs.Balance Required for Interest Calculation")),r(6),u(c(10,4,a.recurringDepositsAccountData.minBalanceForInterestCalculation))}}function xs(e,s){if(e&1&&(n(0,"div",2),t(1,`
    `),n(2,"table"),t(3,`
      `),n(4,"tbody"),t(5,`
        `),n(6,"tr"),t(7,`
      ...
      `),i(),t(91,`
    `),i(),t(92,`
  `),i()),e&2){let a=_();r(9),u(c(10,20,"labels.inputs.External Id")),r(5),d("ngIf",a.recurringDepositsAccountData.externalId),r(2),d("ngIf",!a.recurringDepositsAccountData.externalId),r(7),u(c(24,22,"labels.inputs.Date of Deposit")),r(5),d("ngIf",!a.recurringDepositsAccountData.expectedFirstDepositOnDate),r(2),d("ngIf",a.recurringDepositsAccountData.expectedFirstDepositOnDate),r(7),u(c(38,24,"labels.inputs.Period")),r(6),M("",a.recurringDepositsAccountData.depositPeriod,"\xA0",a.recurringDepositsAccountData.depositPeriodFrequency.value,""),r(4),d("ngIf",a.recurringDepositsAccountData.maturityDate),r(5),u(c(53,26,"labels.inputs.Total Deposits")),r(5),d("ngIf",a.recurringDepositsAccountData.summary.totalDeposits),r(2),d("ngIf",!a.recurringDepositsAccountData.summary.totalDeposits),r(7),u(c(67,28,"labels.inputs.Actual Available Balance")),r(4),x(`
            `,G(71,30,a.recurringDepositsAccountData.summary.accountBalance,a.currency.code,"symbol-narrow","1.2-2"),`
          `),r(7),u(c(78,35,"labels.inputs.Recurring Deposit Amount")),r(4),x(`
            `,G(82,37,a.recurringDepositsAccountData.mandatoryRecommendedDepositAmount,a.currency.code,"symbol-narrow","1.2-2"),`
          `),r(4),d("ngIf",a.recurringDepositsAccountData.summary.totalInterestEarned),r(2),d("ngIf",a.recurringDepositsAccountData.summary.totalWithdrawals),r(2),d("ngIf",a.recurringDepositsAccountData.minBalanceForInterestCalculation)}}function fs(e,s){if(e&1&&(n(0,"span"),t(1),o(2,"currency"),i()),e&2){let a=_(2);r(),u(G(2,1,a.recurringDepositsAccountData.depositAmount,a.currency.code,"symbol-narrow","1.2-2"))}}function _s(e,s){if(e&1&&(n(0,"span"),t(1),o(2,"currency"),i()),e&2){let a=_(2);r(),u(G(2,1,0,a.currency.code,"symbol-narrow","1.2-2"))}}function Cs(e,s){if(e&1&&(n(0,"tr"),t(1,`
          `),n(2,"td"),t(3),o(4,"translate"),i(),t(5,`
          `),n(6,"td",7),t(7,`
            `),n(8,"span"),t(9),o(10,"currency"),i(),t(11,`
          `),i(),t(12,`
        `),i()),e&2){let a=_(2);r(3),u(c(4,2,"labels.inputs.Maturity Amount")),r(6),u(G(10,4,a.recurringDepositsAccountData.maturityAmount,a.currency.code,"symbol-narrow","1.2-2"))}}function hs(e,s){if(e&1&&(n(0,"span"),t(1),o(2,"currency"),i()),e&2){let a=_(2);r(),u(G(2,1,a.recurringDepositsAccountData.summary.totalWithdrawals,a.currency.code,"symbol-narrow","1.2-2"))}}function Ds(e,s){if(e&1&&(n(0,"span"),t(1),o(2,"currency"),i()),e&2){let a=_(2);r(),u(G(2,1,0,a.currency.code,"symbol-narrow","1.2-2"))}}function vs(e,s){if(e&1&&(n(0,"tr"),t(1,`
          `),n(2,"td"),t(3),o(4,"translate"),i(),t(5,`
        ...
        `),i()),e&2){let a=_(2);r(3),u(c(4,2,"labels.inputs.Closed on Date")),r(4),x(`
          ...
          `)}}function bs(e,s){if(e&1&&(n(0,"span"),t(1),o(2,"currency"),i()),e&2){let a=_(3);r(),u(G(2,1,a.recurringDepositsAccountData.summary.totalInterestPosted,a.currency.code,"symbol-narrow","1.2-2"))}}function Ss(e,s){if(e&1&&(n(0,"span"),t(1),o(2,"currency"),i()),e&2){let a=_(3);r(),u(G(2,1,0,a.currency.code,"symbol-narrow","1.2-2"))}}function Ps(e,s){if(e&1&&(n(0,"tr"),t(1,`
          `),n(2,"td"),t(3),o(4,"translate"),i(),t(5,`
          `),n(6,"td",7),t(7,`
            `),m(8,bs,3,6,"span",4),t(9,`
            `),m(10,Ss,3,6,"span",4),t(11,`
          `),i(),t(12,`
        `),i()),e&2){let a=_(2);r(3),u(c(4,3,"labels.inputs.Interests Posted")),r(5),d("ngIf",a.recurringDepositsAccountData.summary.totalInterestPosted),r(2),d("ngIf",!a.recurringDepositsAccountData.summary.totalInterestPosted)}}function Ts(e,s){if(e&1&&(n(0,"div",2),t(1,`
    `),n(2,"table"),t(3,`
      `),n(4,"tbody"),t(5,`
        `),n(6,"tr"),t(7,`
          `),n(8,"td"),t(9),o(10,"translate"),i(),t(11,`
      ...
      `),i(),t(65,`
    `),i(),t(66,`
  `),i()),e&2){let a=_();r(9),u(c(10,14,"labels.inputs.Principal Amount")),r(5),d("ngIf",a.recurringDepositsAccountData.depositAmount),r(2),d("ngIf",!a.recurringDepositsAccountData.depositAmount),r(7),u(c(24,16,"labels.inputs.Rate of Interest")),r(6),x("",c(30,18,a.recurringDepositsAccountData.nominalAnnualInterestRate)," %"),r(5),d("ngIf",a.recurringDepositsAccountData.maturityDate),r(5),u(c(40,20,"labels.inputs.Total Withdrawls")),r(5),d("ngIf",a.recurringDepositsAccountData.summary.totalWithdrawals),r(2),d("ngIf",!a.recurringDepositsAccountData.summary.totalWithdrawals),r(4),d("ngIf",a.recurringDepositsAccountData.timeline.closedOnDate),r(5),u(c(56,22,"labels.inputs.Deposits Frequency")),r(4),M(`
            `,a.recurringDepositsAccountData.recurringFrequency,"\xA0",w(60,24,a.recurringDepositsAccountData.recurringFrequencyType.value,"catalogs"),`
          `),r(4),d("ngIf",a.recurringDepositsAccountData.summary.totalInterestEarned)}}function Ms(e,s){if(e&1&&(n(0,"tr"),t(1,`
          `),n(2,"td"),t(3),o(4,"translate"),i(),t(5,`
          `),n(6,"td"),t(7,`
            `),n(8,"span"),t(9),o(10,"translateKey"),i(),t(11,`
          `),i(),t(12,`
        `),i()),e&2){let a=_(2);r(3),u(c(4,3,"labels.inputs.Pre-closure penal Interest (less)")),r(6),M("",a.recurringDepositsAccountData.preClosurePenalInterest,` % on
              `,w(10,5,a.recurringDepositsAccountData.preClosurePenalInterestOnType.value,"catalogs"),"")}}function ys(e,s){if(e&1&&(n(0,"div",2),t(1,`
    `),n(2,"h4",3),t(3),o(4,"translate"),i(),t(5,`
    `),n(6,"table"),t(7,`
      `),n(8,"tbody"),t(9,`
        `),n(10,"tr"),t(11,`
      ...
      `),i(),t(79,`
    `),i(),t(80,`
  `),i()),e&2){let a=_();r(3),u(c(4,12,"labels.heading.Interest Details")),r(10),u(c(14,14,"labels.inputs.Interest Rate")),r(4),x("",c(18,16,a.recurringDepositsAccountData.nominalAnnualInterestRate)," %"),r(7),u(c(25,18,"labels.inputs.Interest Compounding Period")),r(6),u(w(31,20,a.recurringDepositsAccountData.interestCompoundingPeriodType.value,"catalogs")),r(8),u(c(39,23,"labels.inputs.Interest Posting Period")),r(6),u(w(45,25,a.recurringDepositsAccountData.interestPostingPeriodType.value,"catalogs")),r(8),u(c(53,28,"labels.inputs.Interest calculated using")),r(6),u(w(59,30,a.recurringDepositsAccountData.interestCalculationType.value,"catalogs")),r(8),u(c(67,33,"labels.inputs.Days in Year")),r(6),u(w(73,35,a.recurringDepositsAccountData.interestCalculationDaysInYearType.value,"catalogs")),r(5),d("ngIf",a.recurringDepositsAccountData.preClosurePenalApplicable)}}function As(e,s){if(e&1&&(n(0,"tr"),t(1,`
          `),n(2,"td"),t(3),o(4,"translate"),i(),t(5,`
          `),n(6,"td"),t(7,`
            `),n(8,"span"),t(9),o(10,"translateKey"),i(),t(11,`
          `),i(),t(12,`
        `),i()),e&2){let a=_(2);r(3),u(c(4,3,"labels.inputs.Pre-closure penal Interest (less)")),r(6),M("",a.recurringDepositsAccountData.preClosurePenalInterest,` % on
              `,w(10,5,a.recurringDepositsAccountData.preClosurePenalInterestOnType.value,"catalogs"),"")}}function Is(e,s){if(e&1&&(n(0,"tr"),t(1,`
          `),n(2,"td"),t(3),o(4,"translate"),i(),t(5,`
          `),n(6,"td"),t(7,`
            `),n(8,"span"),t(9),i(),t(10,`
          `),i(),t(11,`
        `),i()),e&2){let a=_(2);r(3),u(c(4,2,"labels.inputs.Witdhold Tax Group")),r(6),u(a.recurringDepositsAccountData.taxGroup.name)}}function Os(e,s){if(e&1&&(n(0,"div",2),t(1,`
    `),n(2,"table"),t(3,`
      `),n(4,"tbody"),t(5,`
        `),n(6,"tr"),t(7,`
          `),n(8,"td"),t(9),o(10,"translate"),i(),t(11,`
