import{a as di}from"./chunk-EQMBOLKF.js";import{a as Fn,b as wn}from"./chunk-VOPTR6IH.js";import{a as mi}from"./chunk-3Z4PVDLG.js";import{$a as jn,$b as En,$c as dt,$e as Qt,Ac as E,Bb as de,Ca as ft,Cd as St,D as Gt,Db as zn,Dd as Pt,E as $e,Ed as Mt,Fa as _t,Fc as J,G as Lt,Ga as Ct,Gc as z,Gd as yt,Ha as ht,Hd as It,Ia as R,Id as ue,Ja as t,K as te,Ka as u,Kc as it,L as P,La as f,Lb as Ee,Lc as V,Ld as st,Lf as ei,M,Ma as S,Mb as Fe,Mc as X,Me as Qn,Na as se,Nc as at,Nd as We,Ob as ce,Od as Ke,Pb as le,Qb as we,Qc as Q,Qf as ni,Rf as fe,S as Le,Sc as ot,Sd as xe,Sf as ii,Ta as k,Tc as Kt,Te as Yn,Tf as ai,Ua as Ge,Uc as Ln,Ud as ke,Ue as Jn,Uf as oi,Vb as N,Vc as rt,Wa as r,Wb as Hn,We as Xe,Xa as c,Xe as Ze,Ya as F,Yb as $,Yc as pt,Yd as De,Ye as tn,Yf as $t,Z as qn,Zb as Y,Zd as Ne,Ze as en,_a as et,_b as $n,_e as re,af as wt,ba as o,bc as Be,bf as Bt,bg as ri,cc as B,cd as ct,cf as Rt,cg as nn,de as Qe,dg as Ve,ed as y,ee as Ye,ef as kt,fa as _,fb as Oe,fd as G,fe as Je,ff as Nt,ga as A,gb as vt,gd as Un,gg as pi,ha as Ue,hb as w,hd as Gn,hf as Vt,ib as ye,id as ut,if as qt,ka as m,kd as Dt,kf as jt,ld as Wn,lf as zt,lg as ci,ma as Ae,md as Kn,na as d,nd as Z,nf as Ht,ng as li,ob as Ie,od as xt,pc as ee,qc as Re,qf as be,ra as n,rc as Wt,rd as bt,sa as i,sb as me,sc as ne,sd as tt,ta as g,tb as O,tc as ie,ua as v,uc as ae,ud as Ft,ug as an,va as D,vc as oe,vd as lt,vf as Xn,vg as si,wf as Zn,xa as I,xd as At,xf as ti,ya as b,za as C,zd as Ot}from"./chunk-EJWBAAPU.js";import{a as j,b as K}from"./chunk-SVF2KWCI.js";var xi=()=>({confirm:!0}),on=(()=>{class e{constructor(a){this.dialogRef=a}static{this.\u0275fac=function(l){return new(l||e)(_(ee))}}static{this.\u0275cmp=A({type:e,selectors:[["mifosx-calculate-interest-dialog"]],decls:22,vars:14,consts:[["mat-dialog-title",""],["mat-dialog-content",""],["align","end"],["mat-raised-button","","mat-dialog-close",""],["mat-raised-button","","color","primary",3,"mat-dialog-close"]],template:function(l,p){l&1&&(n(0,"h1",0),t(1),r(2,"translate"),i(),t(3,`
`),n(4,"div",1),t(5,`
...
`)),l&2){let x=R(59),h=R(73),T=R(78),nt=R(85),Xt=R(95);o(10),ft("matTooltip",c(11,27,"tooltips.Fixed Deposits Account")),d("src","assets/images/fd_account_placeholder.png",qn),o(15),d("ngClass",c(26,29,p.fixedDepositsAccountData.status.code))("matTooltip",p.fixedDepositsAccountData.status.value),o(2),S(`
      ...
      `),o(3),d("ngIf",p.fixedDepositsAccountData.clientId),o(2),d("ngForOf",p.savingsDatatables)}},dependencies:[O,Oe,vt,w,me,y,Y,G,ut,ue,E,It,Wn,Gn,Kn,xe,Un,ci,Be,Je,Ke,st,Ye,Qe,Xn,Zn,$n,ti,Hn,ii],encapsulation:2})}}return e})();function Fi(e,s){e&1&&(n(0,"th",17),t(1),r(2,"translate"),i()),e&2&&(o(),u(c(2,1,"labels.inputs.Period")))}function wi(e,s){if(e&1&&(n(0,"td",18),t(1),r(2,"translateKey"),i()),e&2){let a=s.$implicit;o(),se(`
...
`)),l&2&&(d("formGroup",p.fixedDepositAccountSettingsForm),o(5),u(c(6,37,"labels.heading.Lock-in Period")),o(6),u(c(12,39,"labels.inputs.Frequency")),o(9),u(c(21,41,"labels.inputs.Type")),o(5),d("ngForOf",p.lockinPeriodFrequencyTypeData),o(5),u(c(31,43,"labels.heading.Minimum Deposit Term")),o(6),u(c(37,45,"labels.inputs.Frequency")),o(6),S(`
    ...
    `),o(4),f(`
      ...
      `))},dependencies:[O,vt,w,y,ot,it,Kt,X,at,dt,rt,pt,tt,Z,xt,lt,Ot,At,B,E,It,ke,We,Qt,st,re],styles:["h4[_ngcontent-%COMP%]{font-weight:500;margin:1em 0}h3[_ngcontent-%COMP%]{font-weight:500}mat-divider[_ngcontent-%COMP%]{margin:1em 0 2em}.margin-v[_ngcontent-%COMP%]{margin:1em 0}.margin-b[_ngcontent-%COMP%]{margin:0 0 1em}.margin-t[_ngcontent-%COMP%]{margin-top:1em}.margin-p[_ngcontent-%COMP%]{margin-top:1.7em}"]})}}return e})();var xp=()=>[2e3];function fp(e,s){if(e&1&&(n(0,"mat-option",24),t(1),i()),e&2){let a=s.$implicit;d("value",a),o(),f(`
        `,a.name,`
