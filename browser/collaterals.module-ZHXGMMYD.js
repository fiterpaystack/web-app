import{$e as Mt,Ab as X,Bd as ft,Cb as Y,D as E,Dd as xt,E as y,Ec as tt,G as w,Gd as ht,Ia as t,Ic as et,Ja as c,Jc as it,Jd as bt,Ka as h,Kc as at,Kf as Rt,L as Q,La as b,Lc as nt,M as z,Nf as Pt,Qc as lt,Sa as B,Tc as ot,Te as vt,Ub as F,Ue as gt,Va as m,Ve as _t,Wa as p,Wc as rt,Wf as Tt,Xb as O,Xe as St,Yb as V,Ye as Dt,Zc as mt,_b as U,_e as It,aa as o,ad as pt,bc as L,bf as Et,cd as A,cf as yt,dd as j,ea as f,ef as wt,fa as R,ga as P,gb as W,gd as H,id as st,ja as d,ld as ct,ma as C,md as dt,pc as Z,pg as Bt,qa as i,qd as ut,ra as a,sa as u,sb as g,sd as Ct,ta as D,ua as I,wa as J,xa as T,ya as K,yc as N}from"./chunk-JHW4P6VO.js";import"./chunk-SVF2KWCI.js";var _=(()=>{class e{constructor(n){this.http=n}getFilteredClients(n,l,r,x,v){let S=new X().set("displayName",x).set("orphansOnly",r.toString()).set("sortOrder",l).set("orderBy",n);return v&&(S=S.set("officeId",v)),this.http.get("/clients",{params:S})}getClientCollateral(n,l){return this.http.get(`/clients/${n}/collaterals/${l}`)}updateClientCollateral(n,l,r){return this.http.put(`/clients/${n}/collaterals/${l}`,r)}deleteCollateral(n,l){return this.http.delete(`/clients/${n}/collaterals/${l}`)}static{this.\u0275fac=function(l){return new(l||e)(w(Y))}}static{this.\u0275prov=E({token:e,factory:e.\u0275fac,providedIn:"root"})}}return e})();var Ht=()=>["edit"];function qt(e,s){e&1&&(i(0,"button",16),t(1,`
