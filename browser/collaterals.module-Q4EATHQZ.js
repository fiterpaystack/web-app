import{$b as U,Bb as X,D as E,Db as Y,Dd as ft,E as y,Fc as tt,Fd as xt,G as w,Id as ht,Ja as t,Jc as et,Ka as c,Kc as it,La as h,Lc as at,Ld as bt,M as Q,Ma as b,Mc as nt,Mf as Rt,N as z,Pf as Pt,Rc as lt,Ta as B,Uc as ot,Vb as F,Ve as vt,Wa as m,We as gt,Xa as p,Xc as rt,Xe as _t,Yb as O,Yf as Tt,Zb as V,Ze as St,_c as mt,_e as Dt,af as It,ba as o,bd as pt,bf as Mt,cc as L,dd as A,df as Et,ed as j,ef as yt,fa as f,ga as R,gf as wt,ha as P,hb as W,hd as H,jd as st,ka as d,na as C,nd as ct,od as dt,qc as Z,ra as i,rg as Bt,sa as a,sd as ut,ta as u,tb as g,ua as D,ud as Ct,va as I,xa as J,ya as T,za as K,zc as N}from"./chunk-TNE4AFTP.js";import"./chunk-SVF2KWCI.js";var _=(()=>{class e{constructor(n){this.http=n}getFilteredClients(n,l,r,x,v){let S=new X().set("displayName",x).set("orphansOnly",r.toString()).set("sortOrder",l).set("orderBy",n);return v&&(S=S.set("officeId",v)),this.http.get("/clients",{params:S})}getClientCollateral(n,l){return this.http.get(`/clients/${n}/collaterals/${l}`)}updateClientCollateral(n,l,r){return this.http.put(`/clients/${n}/collaterals/${l}`,r)}deleteCollateral(n,l){return this.http.delete(`/clients/${n}/collaterals/${l}`)}static{this.\u0275fac=function(l){return new(l||e)(w(Y))}}static{this.\u0275prov=E({token:e,factory:e.\u0275fac,providedIn:"root"})}}return e})();var Ht=()=>["edit"];function qt(e,s){e&1&&(i(0,"button",16),t(1,`
