import{$e as It,Ab as X,Cb as Y,Cd as ft,D as E,E as y,Ec as tt,Ed as xt,G as w,Hd as ht,Ia as t,Ic as et,Ja as c,Jc as it,Ka as h,Kc as at,Kd as bt,L as Q,La as b,Lc as nt,Lf as Rt,M as z,Of as Pt,Qc as lt,Sa as B,Tc as ot,Ub as F,Ue as vt,Va as m,Ve as gt,Wa as p,Wc as rt,We as _t,Xb as O,Xf as Tt,Yb as V,Ye as St,Zc as mt,Ze as Dt,_b as U,aa as o,ad as pt,af as Mt,bc as L,cd as A,cf as Et,dd as j,df as yt,ea as f,fa as R,ff as wt,ga as P,gb as W,gd as H,id as st,ja as d,ma as C,md as ct,nd as dt,pc as Z,qa as i,qg as Bt,ra as a,rd as ut,sa as u,sb as g,ta as D,td as Ct,ua as I,wa as J,xa as T,ya as K,yc as N}from"./chunk-FEW77YMG.js";import"./chunk-SVF2KWCI.js";var _=(()=>{class e{constructor(n){this.http=n}getFilteredClients(n,l,r,x,v){let S=new X().set("displayName",x).set("orphansOnly",r.toString()).set("sortOrder",l).set("orderBy",n);return v&&(S=S.set("officeId",v)),this.http.get("/clients",{params:S})}getClientCollateral(n,l){return this.http.get(`/clients/${n}/collaterals/${l}`)}updateClientCollateral(n,l,r){return this.http.put(`/clients/${n}/collaterals/${l}`,r)}deleteCollateral(n,l){return this.http.delete(`/clients/${n}/collaterals/${l}`)}static{this.\u0275fac=function(l){return new(l||e)(w(Y))}}static{this.\u0275prov=E({token:e,factory:e.\u0275fac,providedIn:"root"})}}return e})();var Ht=()=>["edit"];function qt(e,s){e&1&&(i(0,"button",16),t(1,`
