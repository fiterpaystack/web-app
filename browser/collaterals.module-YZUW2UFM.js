import{$b as U,$c as mt,$f as Tt,Ac as N,Bb as X,D as E,Db as Y,E as y,G as w,Gc as tt,Gd as ft,Id as xt,Ja as t,Ka as c,Kc as et,L as Q,La as h,Lc as it,Ld as ht,M as z,Ma as b,Mc as at,Nc as nt,Od as bt,Pf as Rt,Sc as lt,Sf as Pt,Ta as B,Vb as F,Vc as ot,Wa as m,Xa as p,Yb as O,Yc as rt,Ye as vt,Zb as V,Ze as gt,_e as _t,af as St,ba as o,bf as Dt,cc as L,cd as pt,df as It,ed as A,ef as Mt,fa as f,fd as j,ga as R,gf as Et,ha as P,hb as W,hf as yt,id as H,jf as wt,ka as d,kd as st,na as C,nd as ct,od as dt,ra as i,rc as Z,sa as a,sd as ut,ta as u,tb as g,ua as D,ug as Bt,va as I,vd as Ct,xa as J,ya as T,za as K}from"./chunk-HHXJHKNV.js";import"./chunk-SVF2KWCI.js";var _=(()=>{class e{constructor(n){this.http=n}getFilteredClients(n,l,r,x,v){let S=new X().set("displayName",x).set("orphansOnly",r.toString()).set("sortOrder",l).set("orderBy",n);return v&&(S=S.set("officeId",v)),this.http.get("/clients",{params:S})}getClientCollateral(n,l){return this.http.get(`/clients/${n}/collaterals/${l}`)}updateClientCollateral(n,l,r){return this.http.put(`/clients/${n}/collaterals/${l}`,r)}deleteCollateral(n,l){return this.http.delete(`/clients/${n}/collaterals/${l}`)}static{this.\u0275fac=function(l){return new(l||e)(w(Y))}}static{this.\u0275prov=E({token:e,factory:e.\u0275fac,providedIn:"root"})}}return e})();var Ht=()=>["edit"];function qt(e,s){e&1&&(i(0,"button",16),t(1,`
