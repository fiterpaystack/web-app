import{$b as U,$c as mt,Ac as N,Bb as X,D as E,Db as Y,E as y,G as w,Gc as tt,Gd as ft,Id as xt,Ja as t,Ka as c,Kc as et,L as Q,La as h,Lc as it,Ld as ht,M as z,Ma as b,Mc as at,Nc as nt,Rf as Rt,Sc as lt,Ta as B,Uf as Pt,Vb as F,Vc as ot,Wa as m,Xa as p,Yb as O,Yc as rt,Zb as V,Zd as bt,af as vt,ba as o,bf as gt,cc as L,cd as pt,cf as _t,cg as Tt,ed as A,ef as St,fa as f,fd as j,ff as Dt,ga as R,ha as P,hb as W,hf as It,id as H,if as Mt,ka as d,kd as st,kf as Et,lf as yt,na as C,nd as ct,nf as wt,od as dt,ra as i,rc as Z,sa as a,sd as ut,ta as u,tb as g,ua as D,va as I,vd as Ct,wg as Bt,xa as J,ya as T,za as K}from"./chunk-LP5X7GDJ.js";import"./chunk-SVF2KWCI.js";var _=(()=>{class e{constructor(n){this.http=n}getFilteredClients(n,l,r,x,v){let S=new X().set("displayName",x).set("orphansOnly",r.toString()).set("sortOrder",l).set("orderBy",n);return v&&(S=S.set("officeId",v)),this.http.get("/clients",{params:S})}getClientCollateral(n,l){return this.http.get(`/clients/${n}/collaterals/${l}`)}updateClientCollateral(n,l,r){return this.http.put(`/clients/${n}/collaterals/${l}`,r)}deleteCollateral(n,l){return this.http.delete(`/clients/${n}/collaterals/${l}`)}static{this.\u0275fac=function(l){return new(l||e)(w(Y))}}static{this.\u0275prov=E({token:e,factory:e.\u0275fac,providedIn:"root"})}}return e})();var Ht=()=>["edit"];function qt(e,s){e&1&&(i(0,"button",16),t(1,`
