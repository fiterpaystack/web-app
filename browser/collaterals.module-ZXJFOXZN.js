import{$ as o,$c as pt,$e as Mt,Bb as Y,Bd as ft,D as E,Dc as tt,Dd as xt,E as y,G as w,Gd as ht,Ha as t,Hc as et,Ia as c,Ic as it,Ja as h,Jc as at,Jd as bt,Ka as b,Kc as nt,Kf as Rt,L as Q,M as z,Nf as Pt,Pc as lt,Ra as B,Sc as ot,Tb as F,Te as vt,Ua as m,Ue as gt,Va as p,Vc as rt,Ve as _t,Wb as O,Wf as Tt,Xb as V,Xe as St,Yc as mt,Ye as Dt,Zb as U,_e as It,ac as L,bd as A,bf as Et,cd as j,cf as yt,da as f,ea as R,ef as wt,fa as P,fb as W,fd as H,hd as st,ia as d,la as C,ld as ct,md as dt,oc as Z,pa as i,pg as Bt,qa as a,qd as ut,ra as u,rb as g,sa as D,sd as Ct,ta as I,va as J,wa as T,xa as K,xc as N,zb as X}from"./chunk-WWSMWO6O.js";import"./chunk-QDSGMOWV.js";var _=(()=>{class e{constructor(n){this.http=n}getFilteredClients(n,l,r,x,v){let S=new X().set("displayName",x).set("orphansOnly",r.toString()).set("sortOrder",l).set("orderBy",n);return v&&(S=S.set("officeId",v)),this.http.get("/clients",{params:S})}getClientCollateral(n,l){return this.http.get(`/clients/${n}/collaterals/${l}`)}updateClientCollateral(n,l,r){return this.http.put(`/clients/${n}/collaterals/${l}`,r)}deleteCollateral(n,l){return this.http.delete(`/clients/${n}/collaterals/${l}`)}static{this.\u0275fac=function(l){return new(l||e)(w(Y))}}static{this.\u0275prov=E({token:e,factory:e.\u0275fac,providedIn:"root"})}}return e})();var Ht=()=>["edit"];function qt(e,s){e&1&&(i(0,"button",16),t(1,`
