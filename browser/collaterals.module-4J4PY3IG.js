import{$e as wt,Bd as ht,D as E,Dc as et,E as y,Ea as t,Ec as it,Ed as bt,Fa as c,Fc as at,Ff as Rt,G as w,Ga as h,Gc as nt,Ha as b,If as Pt,J as Q,K as z,Lc as lt,Oa as B,Oc as ot,Oe as vt,Pb as F,Pe as gt,Qe as _t,Ra as m,Rc as rt,Rf as Tt,Sa as p,Sb as O,Se as St,Tb as V,Te as Dt,Uc as mt,Vb as U,Ve as It,We as Mt,Xc as pt,Yb as L,Ye as Et,Z as o,Zc as A,Ze as yt,_c as j,ba as f,bb as W,bd as H,ca as R,da as P,dd as st,ga as d,hd as ct,ia as C,id as dt,kc as Z,kg as Bt,ma as i,md as ut,na as a,nb as g,oa as u,od as Ct,pa as D,qa as I,sa as J,ta as T,tc as N,ua as K,vb as X,wd as ft,xb as Y,yd as xt,zc as tt}from"./chunk-TETLHMRJ.js";import"./chunk-QDSGMOWV.js";var _=(()=>{class e{constructor(n){this.http=n}getFilteredClients(n,l,r,x,v){let S=new X().set("displayName",x).set("orphansOnly",r.toString()).set("sortOrder",l).set("orderBy",n);return v&&(S=S.set("officeId",v)),this.http.get("/clients",{params:S})}getClientCollateral(n,l){return this.http.get(`/clients/${n}/collaterals/${l}`)}updateClientCollateral(n,l,r){return this.http.put(`/clients/${n}/collaterals/${l}`,r)}deleteCollateral(n,l){return this.http.delete(`/clients/${n}/collaterals/${l}`)}static{this.\u0275fac=function(l){return new(l||e)(w(Y))}}static{this.\u0275prov=E({token:e,factory:e.\u0275fac,providedIn:"root"})}}return e})();var Ht=()=>["edit"];function qt(e,s){e&1&&(i(0,"button",16),t(1,`
